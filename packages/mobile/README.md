...
- Root chat rows can move an idle chat and its sub-chats into a generated worktree from their swipe actions. The session history and checkout changes move with them, matching the web and Desktop action.
