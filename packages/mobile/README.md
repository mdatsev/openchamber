...
- Root chat rows can move an idle chat and its sub-chats into a generated worktree from their swipe actions. Session history always moves; the browser-local Custom Fork preference controls whether checkout changes move too, matching the web and Desktop action.
