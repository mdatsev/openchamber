...
export const dict: Record<I18nKey, string> = {
  ...
  "walkthrough.search.placeholder": "Пошук у diff...",
  "walkthrough.search.resultCount": "{current} з {total}",
  "walkthrough.search.previous": "Попередній збіг",
  "walkthrough.search.next": "Наступний збіг",
  "walkthrough.search.close": "Закрити пошук",
  ...
  "chat.statusRow.interruptedUnexpectedly": "Неочікувано перервано",
  ...
  "chat.chatInput.placeholder.prime": "Напишіть Prime Agent…",
  "chat.primeComposer.pending": "Оновлення Prime Agent…",
  "chat.primeComposer.outcomeUncertain": "Prime Agent міг отримати цю дію. Виберіть її ще раз, щоб безпечно повторити спробу.",
  "chat.primeComposer.failed": "Prime Agent не зміг завершити цю дію.",
  "chat.primeComposer.draftLimitReached": "Розмір повідомлення обмежено 256 KiB.",
  "chat.draftHarness.pickerAria": "Вибрати середовище агента",
  "chat.primeDraft.creating": "Створення сесії Prime Agent…",
  "chat.primeDraft.creationUncertain": "Можливо, створення завершилося успішно. Перевірте список сесій, перш ніж повторювати спробу.",
  "chat.primeDraft.unsupported": "Створення сесій Prime Agent не підтримується в цьому середовищі.",
  "chat.primeDraft.creationFailed": "Не вдалося створити сесію Prime Agent.",
  "chat.primeDraft.configurationUnavailable": "Вибрана модель або налаштування міркування більше не доступні з актуального сеансу Prime. Чернетку збережено.",
  "chat.primeDraft.sourceRefreshFailed": "Не вдалося оновити параметри Prime. Зачекайте трохи й повторіть спробу; чернетку збережено.",
  "chat.primeDraft.modelControls.defaults": "Типові налаштування Prime",
  "chat.primeDraft.modelControls.loadOptions": "Завантажити параметри Prime",
  "chat.primeDraft.modelControls.loadingOptions": "Завантаження параметрів Prime…",
  "chat.primeDraft.modelControls.optionsRequireExistingSession": "Для параметрів Prime потрібен наявний сеанс Prime",
  "chat.primeDraft.modelControls.primeDefaultThinking": "Типове міркування Prime",
  "chat.primeSession.liveControls.readOnly": "Елементи керування наживо від’єднано. Збережена розшифровка доступна лише для читання.",
  "chat.primeSession.liveControls.reconnect": "Під’єднатися знову",
  "chat.primeSession.liveControls.enable": "Увімкнути керування наживо",
  "chat.primeSession.liveControls.reconnecting": "Повторне підключення…",
  "chat.primeComposer.liveReconnecting": "Повторне підключення елементів керування наживо…",
  "chat.primeSession.readOnlyUnavailable": "Ця розмова Prime Agent доступна лише для читання. Не вдалося повторно відкрити її середовище виконання, тому контекст наживо й елементи керування повідомленнями недоступні.",
  ...
  "chat.toolPart.ipythonDiffsOmitted": "Пропущені зміни редагування: {count}",
  ...
  "updateDialog.sourceRun.description": "Цю інсталяцію запущено з вихідного коду. Об’єднайте випуск upstream зі своєю гілкою та перезапустіть OpenChamber.",
  ...
  "updateDialog.actions.mergeUpstreamRelease": "Об’єднати випуск upstream для оновлення",
  ...
  'chat.container.partialTranscript.description': 'Показано доступні зараз дані розмови. Деякі старі, завеликі або недоступні дані можуть не відображатися.',
};
