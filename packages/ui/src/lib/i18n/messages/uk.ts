...
export const dict: Record<I18nKey, string> = {
  ...
  'prime.transcript.readOnly': 'Лише для читання',
  'harness.selector.label': 'Середовище програмування',
  'prime.composer.placeholder': 'Запитайте Prime Agent...',
  'prime.status.working': 'Працює',
  'prime.unavailable.description': 'Prime Agent недоступний. Налаштуйте виконуваний файл у загальних параметрах або повторіть підключення.',
  'prime.composer.textOnly': 'Наразі Prime Agent приймає лише текстові запити.',
  'prime.composer.ambiguous': 'Prime Agent міг отримати цей запит. Перевірте його поточний стан перед повторною спробою.',
  'prime.composer.createFailed': 'Не вдалося створити сеанс Prime Agent.',
  'prime.composer.sendFailed': 'Не вдалося надіслати запит до Prime Agent.',
  'prime.composer.abortFailed': 'Не вдалося зупинити Prime Agent.',
