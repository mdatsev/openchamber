...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.group.empty.noSessions": "Немає сесій",
  ...
  "sessions.sidebar.session.moveToWorktree.confirm.title": "Перенести незакомічені зміни?",
  "sessions.sidebar.session.moveToWorktree.confirm.description": "У цьому checkout є незакомічені зміни. Виберіть, чи перенести їх у новий worktree, чи залишити в поточному checkout.",
  "sessions.sidebar.session.moveToWorktree.confirm.leaveChanges": "Залишити зміни",
  "sessions.sidebar.session.moveToWorktree.confirm.moveChanges": "Перенести зміни",
  ...
  "sessions.sidebar.session.status.linkedWorktree": "Пов’язаний worktree",
  "sessions.sidebar.session.status.worktreeClean": "Немає відмінностей від {branch}",
  ...
  "gitView.changes.revertFileDescription": "Локальні зміни у файлі {path} буде відкинуто. Цю дію неможливо скасувати.",
  ...
  "diffView.scope.branchAgainst": "Зміни відносно {branch}",
  "diffView.scope.workingTree": "Робоче дерево",
  "diffView.comparison.mode.uncommitted": "Незакомічені",
  "diffView.comparison.mode.committed": "Закомічені",
  "diffView.comparison.mode.combined": "Об’єднані",
  "diffView.comparison.mode.selectorAria": "Вибрати режим порівняння",
  "diffView.comparison.layer.committed": "Закомічені зміни",
  "diffView.comparison.layer.staged": "Індексовані зміни",
  "diffView.comparison.layer.unstaged": "Неіндексовані зміни",
  "diffView.comparison.layer.untracked": "Невідстежувані файли",
  "diffView.comparison.layer.combined": "Об’єднані зміни",
  "diffView.state.loadingBranchChanges": "Завантаження змін гілки...",
  "diffView.state.branchLoadFailed": "Не вдалося завантажити зміни гілки",
  "diffView.state.noBranchChanges": "Немає змін відносно {branch}",
  "diffView.state.noUncommittedChanges": "Немає незакомічених змін",
  "diffView.state.noCommittedChanges": "Немає закомічених змін відносно {branch}",
  "diffView.state.noCombinedChanges": "Немає закомічених або незакомічених змін відносно {branch}",
  "sessions.sidebar.worktreeChanges": "Файли, що відрізняються від {branch}: {count}",
  ...
  "updateDialog.sourceRun.description": "Цю інсталяцію запущено з вихідного коду. Попросіть агента об’єднати випуск upstream із вашою гілкою, перевірити зміни та перезапустити OpenChamber.",
  ...
  "updateDialog.actions.mergeUpstreamRelease": "Потрібне об’єднання агентом",
