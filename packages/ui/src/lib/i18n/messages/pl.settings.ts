export const settingsDict = {
  ...
  'settings.openchamber.primeAgent.field.binaryPath': 'Ścieżka do pliku wykonywalnego Prime Agent',
  'settings.openchamber.primeAgent.field.binaryPathInfo': 'Wybierz plik wykonywalny lub program uruchamiający Prime Agent. Jeśli pole jest puste, OpenChamber sprawdza PRIME_AGENT_BINARY, a następnie PATH.',
  'settings.openchamber.primeAgent.actions.browseAria': 'Wybierz plik wykonywalny Prime Agent',
  'settings.openchamber.primeAgent.actions.save': 'Zapisz',
