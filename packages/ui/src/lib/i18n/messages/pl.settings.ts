export const settingsDict = {
  ...
  'settings.openchamber.opencodeCli.field.update': 'Aktualizacja OpenCode',
  'settings.openchamber.opencodeCli.field.updateInfo': 'Aktualizuje tylko interfejs wiersza poleceń OpenCode. Nie aktualizuje OpenChamber ani nie modyfikuje gałęzi Git.',
  'settings.openchamber.opencodeCli.state.updateUnavailable': 'Tego środowiska OpenCode nie można zaktualizować tutaj.',
  'settings.openchamber.opencodeCli.state.checkFailed': 'Nie udało się sprawdzić aktualizacji OpenCode.',
