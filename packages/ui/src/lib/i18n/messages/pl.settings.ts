export const settingsDict = {
  ...
  'settings.view.nav.group.fork': 'Niestandardowy fork',
  'settings.page.fork.title': 'Ustawienia forka',
  'settings.page.fork.description': 'Ustawienia i operacje środowiska dostępne tylko w tym niestandardowym forku OpenChamber.',
  ...
  'settings.fork.section.runtime': 'Środowisko uruchomieniowe',
  'settings.fork.restart.label': 'Uruchom ponownie OpenChamber',
  'settings.fork.restart.info': 'Uruchamia ponownie tylko ten interfejs OpenChamber. OpenCode i aktywni agenci nadal działają, a ta strona zostanie ponownie wczytana, gdy interfejs będzie znów dostępny.',
  'settings.fork.restart.action': 'Uruchom ponownie',
  'settings.fork.restart.checking': 'Sprawdzanie...',
  'settings.fork.restart.restarting': 'Ponowne uruchamianie...',
  'settings.fork.restart.checkAgain': 'Sprawdź ponownie',
  'settings.fork.restart.unavailable': 'Niedostępne',
  'settings.fork.restart.loadError': 'Nie udało się sprawdzić, czy to środowisko obsługuje zarządzane ponowne uruchamianie.',
  'settings.fork.restart.failed': 'Nie udało się ponownie uruchomić OpenChamber.',
  'settings.fork.restart.timeout': 'Ponowne uruchamianie OpenChamber trwa dłużej niż oczekiwano. Spróbuj ponownie wczytać tę stronę.',
  'settings.fork.opencodeUpdate.label': 'Zaktualizuj OpenCode',
  'settings.fork.opencodeUpdate.info': 'Aktualizuje tylko OpenCode. W środowisku nadzorowanym przez systemd czeka na zakończenie aktywnych agentów, a następnie ponownie uruchamia OpenCode. OpenChamber i gałęzie Git pozostają bez zmian.',
  'settings.fork.opencodeUpdate.state.updateUnavailable': 'To środowisko OpenCode nie jest zarządzane przez ten fork.',
  'settings.fork.opencodeUpdate.state.checkFailed': 'Nie udało się sprawdzić aktualizacji OpenCode.',
  'settings.fork.opencodeUpdate.state.queued': 'Oczekiwanie na zakończenie aktywnych agentów przed aktualizacją OpenCode.',
  'settings.fork.opencodeUpdate.state.restarting': 'Ponowne uruchamianie OpenCode...',
  'settings.fork.opencodeUpdate.actions.queued': 'W kolejce',
  'settings.fork.runtime.checking': 'Sprawdzanie...',
  'settings.fork.runtime.refresh': 'Odśwież status',
  'settings.fork.runtime.loadFailed': 'Nie udało się wczytać statusu środowiska.',
  'settings.fork.runtime.actionFailed': 'Operacja środowiska nie powiodła się.',
  'settings.fork.runtime.cancelFailed': 'Nie udało się anulować operacji oczekującej w kolejce.',
  'settings.fork.runtime.unknown': 'Nieznane',
  'settings.fork.runtime.unavailable': 'Niedostępne',
  'settings.fork.runtime.none': 'Brak',
  'settings.fork.runtime.current': 'Zsynchronizowano z niestandardowym upstreamem',
  'settings.fork.runtime.ahead': 'Commity przed niestandardowym upstreamem: {count}',
  'settings.fork.runtime.behind': 'Commity za niestandardowym upstreamem: {count}',
  'settings.fork.runtime.diverged': 'Historie się rozeszły; zarządzana aktualizacja została zablokowana.',
  'settings.fork.runtime.comparisonUnknown': 'Porównanie z niestandardowym upstreamem jest niedostępne.',
  'settings.fork.runtime.release': 'Wydanie: {version}',
  'settings.fork.runtime.tag': 'Dokładny tag: {tag}',
  'settings.fork.runtime.branch': 'Gałąź: {branch}',
  'settings.fork.runtime.clean': 'Brak zmian w checkoutcie',
  'settings.fork.runtime.dirty': 'Checkout zawiera lokalne zmiany',
  'settings.fork.runtime.stale': 'To ostatni pomyślnie pobrany wynik; najnowsze odświeżenie nie powiodło się.',
  'settings.fork.runtime.startedAt': 'Uruchomienie procesu: {time}',
  'settings.fork.runtime.status.label': 'Źródło statusu',
  'settings.fork.runtime.status.checkedAt': 'Sprawdzono: {time}',
  'settings.fork.runtime.status.notChecked': 'Status nie został jeszcze sprawdzony.',
  'settings.fork.runtime.operation.label': 'Bieżąca operacja',
  'settings.fork.runtime.operation.idle': 'Brak trwającej operacji',
  'settings.fork.runtime.operation.failed': 'Operacja nie powiodła się',
  'settings.fork.runtime.operation.from': 'Commit źródłowy: {commit}',
  'settings.fork.runtime.operation.target': 'Commit docelowy: {commit}',
  'settings.fork.runtime.operation.updatedAt': 'Ostatnia aktualizacja postępu: {time}',
  'settings.fork.runtime.opencode.title': 'OpenCode',
  'settings.fork.runtime.opencode.description': 'Działający proces, zainstalowany plik wykonywalny, publiczne wydanie i stan zarządzanego cyklu życia.',
  'settings.fork.runtime.opencode.runningVersion': 'Wersja działającego / połączonego procesu',
  'settings.fork.runtime.opencode.runningVersionDescription': 'Wersja zgłoszona przez proces OpenCode połączony obecnie z tym serwerem OpenChamber.',
  'settings.fork.runtime.opencode.installedVersion': 'Wersja zainstalowanego pliku wykonywalnego',
  'settings.fork.runtime.opencode.installedVersionDescription': 'Odczytana bezpośrednio z pliku wykonywalnego skonfigurowanego dla zarządzanej usługi OpenCode.',
  'settings.fork.runtime.opencode.latestVersion': 'Najnowsza wersja publiczna',
  'settings.fork.runtime.opencode.latestVersionDescription': 'Najwyższa wersja zgłoszona przez pakiet npm OpenCode i wydania GitHub.',
  'settings.fork.runtime.opencode.latestInstalled': 'Połączony proces OpenCode korzysta z najnowszej dostępnej wersji.',
  'settings.fork.runtime.opencode.manager': 'Menedżer cyklu życia',
  'settings.fork.runtime.opencode.managerSupported': 'To środowisko obsługuje zarządzaną aktualizację. Dla OpenCode zarządzanego przez systemd dostępne jest także osobne ponowne uruchomienie.',
  'settings.fork.runtime.opencode.managerUnsupported': 'Ten proces OpenCode nie jest zarządzany przez połączone środowisko OpenChamber.',
  'settings.fork.runtime.opencode.activeAgentSingle': 'Operacja będzie kontynuowana, gdy {count} aktywny agent zakończy pracę.',
  'settings.fork.runtime.opencode.activeAgentPlural': 'Operacja będzie kontynuowana po zakończeniu pracy aktywnych agentów (liczba: {count}).',
  'settings.fork.runtime.opencode.operation.updateQueued': 'Aktualizacja w kolejce; oczekiwanie na aktywnych agentów',
  'settings.fork.runtime.opencode.operation.restartQueued': 'Ponowne uruchomienie w kolejce; oczekiwanie na aktywnych agentów',
  'settings.fork.runtime.opencode.operation.updating': 'Instalowanie najnowszej wersji OpenCode',
  'settings.fork.runtime.opencode.operation.restarting': 'Ponowne uruchamianie OpenCode i łączenie transportów',
  'settings.fork.runtime.opencode.operation.updated': 'Aktualizacja OpenCode zakończona',
  'settings.fork.runtime.opencode.operation.restarted': 'Ponowne uruchomienie OpenCode zakończone',
  'settings.fork.runtime.opencode.updateAction': 'Zaktualizuj OpenCode do najnowszej wersji',
  'settings.fork.runtime.opencode.updateAvailable': 'Dostępna jest wersja {version}. Przed zarządzanym ponownym uruchomieniem aktywni agenci mogą dokończyć pracę.',
  'settings.fork.runtime.opencode.noUpdate': 'Obecnie nie jest dostępna nowsza wersja OpenCode.',
  'settings.fork.runtime.opencode.updateUnsupported': 'To środowisko nie może zaktualizować połączonego procesu OpenCode.',
  'settings.fork.runtime.opencode.restartAction': 'Uruchom ponownie OpenCode',
  'settings.fork.runtime.opencode.restartDescription': 'Zatrzymuje rozpoczynanie nowych tur, czeka na zakończenie aktywnych agentów, ponownie uruchamia zewnętrzną usługę OpenCode i ponownie łączy OpenChamber.',
  'settings.fork.runtime.opencode.restartUnsupported': 'Osobne ponowne uruchomienie wymaga nadzorowanego zewnętrznego środowiska systemd.',
  'settings.fork.runtime.openchamber.title': 'OpenChamber',
  'settings.fork.runtime.openchamber.description': 'Wczytane rewizje serwera i interfejsu, bieżący checkout, wydania upstreamu i stan zarządzanego wdrożenia ze źródeł.',
  'settings.fork.runtime.openchamber.running': 'Rewizja działającego serwera',
  'settings.fork.runtime.openchamber.loadedUi': 'Wczytana rewizja interfejsu przeglądarki',
  'settings.fork.runtime.openchamber.loadedUiMismatch': 'Wczytane zasoby przeglądarki różnią się od rewizji działającego serwera.',
  'settings.fork.runtime.openchamber.loadedUiMatches': 'Wczytane zasoby przeglądarki są zgodne z rewizją działającego serwera.',
  'settings.fork.runtime.openchamber.loadedUiDirty': 'Interfejs przeglądarki został zbudowany z checkoutu zawierającego lokalne zmiany.',
  'settings.fork.runtime.openchamber.loadedUiClean': 'Interfejs przeglądarki został zbudowany z czystego checkoutu.',
  'settings.fork.runtime.openchamber.checkout': 'Rewizja źródeł w checkoutcie',
  'settings.fork.runtime.openchamber.restartRequired': 'Uruchom ponownie OpenChamber, aby użyć tej rewizji z checkoutu.',
  'settings.fork.runtime.openchamber.customUpstream': 'Najnowszy niestandardowy upstream',
  'settings.fork.runtime.openchamber.officialRelease': 'Najnowsze oficjalne wydanie',
  'settings.fork.runtime.openchamber.updateAction': 'Pobierz i zbuduj najnowszą wersję niestandardową',
  'settings.fork.runtime.openchamber.deployment': 'Zarządzane wdrożenie źródeł',
  'settings.fork.runtime.openchamber.rebuildAction': 'Zbuduj bieżący checkout',
  'settings.fork.runtime.openchamber.rebuildDescription': 'Buduje i sprawdza bieżący czysty checkout w środowisku przejściowym, a następnie zapisuje jego zależności i zasoby webowe do zastosowania przy następnym restarcie OpenChamber.',
  'settings.fork.runtime.openchamber.sourceCurrent': 'Checkout źródłowy jest aktualny.',
  'settings.fork.runtime.openchamber.updateDescription': 'Pobiera kanoniczną gałąź niestandardową, sprawdza możliwość czystego fast-forward, instaluje zależności i wykonuje kompilację w środowisku przejściowym, a następnie rejestruje przygotowaną aktualizację. Aktualnie używane źródła i zasoby zmieniają się dopiero po ponownym uruchomieniu OpenChamber.',
  'settings.fork.runtime.openchamber.noUpdate': 'Checkout jest aktualny albo bezpieczna zarządzana aktualizacja jest niedostępna. Dokładna przyczyna jest pokazana powyżej.',
  'settings.fork.runtime.openchamber.restartApplyDescription': 'Uruchamia ponownie tylko OpenChamber, aby wczytać przygotowane źródła i zasoby aplikacji webowej. OpenCode i aktywni agenci nadal działają.',
  'settings.fork.runtime.openchamber.operation.checking': 'Sprawdzanie checkoutu i kanonicznego upstreamu',
  'settings.fork.runtime.openchamber.operation.preparing': 'Przygotowywanie odłączonego checkoutu przejściowego',
  'settings.fork.runtime.openchamber.operation.installing': 'Instalowanie przygotowanych zależności',
  'settings.fork.runtime.openchamber.operation.building': 'Kompilowanie i sprawdzanie przygotowanych zasobów aplikacji webowej',
  'settings.fork.runtime.openchamber.operation.applying': 'Rejestrowanie przygotowanej aktualizacji na potrzeby zarządzanego ponownego uruchomienia',
  'settings.fork.runtime.openchamber.operation.ready': 'Aktualizacja forka jest gotowa; uruchom ponownie OpenChamber, aby ją zastosować',
  'settings.fork.runtime.openchamber.operation.failed': 'Aktualizacja forka nie powiodła się; działająca rewizja nie została ponownie uruchomiona',
