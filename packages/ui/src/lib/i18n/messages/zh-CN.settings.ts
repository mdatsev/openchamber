...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.opencodeCli.field.updateInfo': '仅更新 OpenCode CLI。不会更新 OpenChamber，也不会修改 Git 分支。',
  'settings.openchamber.opencodeCli.state.updateUnavailable': '无法在此处更新此 OpenCode 运行时。',
  'settings.openchamber.opencodeCli.state.checkFailed': '无法检查 OpenCode 更新。',
