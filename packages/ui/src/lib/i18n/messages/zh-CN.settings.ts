...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.primeAgent.field.binaryPath': 'Prime Agent 可执行文件路径',
  'settings.openchamber.primeAgent.field.binaryPathInfo': '选择 Prime Agent 可执行文件或启动器。如果留空，OpenChamber 将依次检查 PRIME_AGENT_BINARY 和 PATH。',
  'settings.openchamber.primeAgent.actions.browseAria': '浏览 Prime Agent 可执行文件',
