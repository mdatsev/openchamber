...
export const settingsDict = {
  ...
  'settings.view.nav.group.fork': '自定义分支',
  'settings.page.fork.title': '分支设置',
  'settings.page.fork.description': '仅在此 OpenChamber 自定义分支中提供的设置和运行环境操作。',
  ...
  'settings.fork.section.runtime': '运行环境',
  'settings.fork.restart.label': '重启 OpenChamber',
  'settings.fork.restart.info': '仅重启此 OpenChamber 界面。OpenCode 和运行中的智能体会继续运行，界面恢复可用后此页面将自动重新加载。',
  'settings.fork.restart.action': '重启',
  'settings.fork.restart.checking': '正在检查...',
  'settings.fork.restart.restarting': '正在重启...',
  'settings.fork.restart.checkAgain': '重新检查',
  'settings.fork.restart.unavailable': '不可用',
  'settings.fork.restart.loadError': '无法检查此运行环境是否支持托管重启。',
  'settings.fork.restart.failed': '无法重启 OpenChamber。',
  'settings.fork.restart.timeout': 'OpenChamber 重启所需时间超出预期。请尝试重新加载此页面。',
  'settings.fork.opencodeUpdate.label': '更新 OpenCode',
  'settings.fork.opencodeUpdate.info': '仅更新 OpenCode。对于由 systemd 监管的运行环境，会等待活动智能体完成后再重启 OpenCode。不会更改 OpenChamber 或 Git 分支。',
  'settings.fork.opencodeUpdate.state.updateUnavailable': '此 OpenCode 运行环境不由此分支管理。',
  'settings.fork.opencodeUpdate.state.checkFailed': '无法检查 OpenCode 更新。',
  'settings.fork.opencodeUpdate.state.queued': '正在等待活动智能体完成，然后更新 OpenCode。',
  'settings.fork.opencodeUpdate.state.restarting': '正在重启 OpenCode...',
  'settings.fork.opencodeUpdate.actions.queued': '已排队',
  'settings.fork.runtime.checking': '正在检查...',
  'settings.fork.runtime.refresh': '刷新状态',
  'settings.fork.runtime.loadFailed': '无法加载运行环境状态。',
  'settings.fork.runtime.actionFailed': '运行环境操作失败。',
  'settings.fork.runtime.cancelFailed': '无法取消队列中的操作。',
  'settings.fork.runtime.unknown': '未知',
  'settings.fork.runtime.unavailable': '不可用',
  'settings.fork.runtime.none': '无',
  'settings.fork.runtime.current': '与自定义上游保持同步',
  'settings.fork.runtime.ahead': '比自定义上游领先 {count} 个提交',
  'settings.fork.runtime.behind': '比自定义上游落后 {count} 个提交',
  'settings.fork.runtime.diverged': '历史记录已分叉；托管更新已被阻止。',
  'settings.fork.runtime.comparisonUnknown': '无法与自定义上游进行比较。',
  'settings.fork.runtime.release': '发布版本：{version}',
  'settings.fork.runtime.tag': '精确标签：{tag}',
  'settings.fork.runtime.branch': '分支：{branch}',
  'settings.fork.runtime.clean': '检出中没有更改',
  'settings.fork.runtime.dirty': '检出中有本地更改',
  'settings.fork.runtime.stale': '这是上次成功的结果；最新刷新失败。',
  'settings.fork.runtime.startedAt': '进程启动时间：{time}',
  'settings.fork.runtime.status.label': '状态来源',
  'settings.fork.runtime.status.checkedAt': '检查时间：{time}',
  'settings.fork.runtime.status.notChecked': '尚未检查状态。',
  'settings.fork.runtime.operation.label': '当前操作',
  'settings.fork.runtime.operation.idle': '没有正在进行的操作',
  'settings.fork.runtime.operation.failed': '操作失败',
  'settings.fork.runtime.operation.from': '起始提交：{commit}',
  'settings.fork.runtime.operation.target': '目标提交：{commit}',
  'settings.fork.runtime.operation.updatedAt': '上次进度更新时间：{time}',
  'settings.fork.runtime.opencode.title': 'OpenCode',
  'settings.fork.runtime.opencode.description': '实时进程、已安装的可执行文件、公开发布版本以及受监管的生命周期状态。',
  'settings.fork.runtime.opencode.runningVersion': '正在运行/已连接的版本',
  'settings.fork.runtime.opencode.runningVersionDescription': '由当前连接到此 OpenChamber 服务器的 OpenCode 进程报告。',
  'settings.fork.runtime.opencode.installedVersion': '已安装的可执行文件版本',
  'settings.fork.runtime.opencode.installedVersionDescription': '直接从为托管 OpenCode 服务配置的可执行文件中读取。',
  'settings.fork.runtime.opencode.latestVersion': '最新公开版本',
  'settings.fork.runtime.opencode.latestVersionDescription': 'OpenCode npm 软件包和 GitHub 发布版本报告的最高版本。',
  'settings.fork.runtime.opencode.latestInstalled': '已连接的 OpenCode 进程正在运行最新可用版本。',
  'settings.fork.runtime.opencode.manager': '生命周期管理器',
  'settings.fork.runtime.opencode.managerSupported': '此运行环境支持受监管的更新。由 systemd 管理的 OpenCode 可单独重启。',
  'settings.fork.runtime.opencode.managerUnsupported': '此 OpenCode 进程不由已连接的 OpenChamber 运行环境管理。',
  'settings.fork.runtime.opencode.activeAgentSingle': '{count} 个活动智能体必须完成运行，操作才能继续。',
  'settings.fork.runtime.opencode.activeAgentPlural': '{count} 个活动智能体必须完成运行，操作才能继续。',
  'settings.fork.runtime.opencode.operation.updateQueued': '更新已排队；正在等待活动智能体完成',
  'settings.fork.runtime.opencode.operation.restartQueued': '重启已排队；正在等待活动智能体完成',
  'settings.fork.runtime.opencode.operation.updating': '正在安装最新版本的 OpenCode',
  'settings.fork.runtime.opencode.operation.restarting': '正在重启 OpenCode 并重新连接传输通道',
  'settings.fork.runtime.opencode.operation.updated': 'OpenCode 更新完成',
  'settings.fork.runtime.opencode.operation.restarted': 'OpenCode 重启完成',
  'settings.fork.runtime.opencode.updateAction': '将 OpenCode 更新到最新版本',
  'settings.fork.runtime.opencode.updateAvailable': '版本 {version} 可用。托管重启会先等待活动智能体完成。',
  'settings.fork.runtime.opencode.noUpdate': '当前没有更新版本的 OpenCode 可用。',
  'settings.fork.runtime.opencode.updateUnsupported': '此运行环境无法更新已连接的 OpenCode 进程。',
  'settings.fork.runtime.opencode.restartAction': '重启 OpenCode',
  'settings.fork.runtime.opencode.restartDescription': '停止接受新的交互轮次，等待活动智能体完成，重启外部 OpenCode 服务，然后重新连接 OpenChamber。',
  'settings.fork.runtime.opencode.restartUnsupported': '单独重启需要受监管的外部 systemd 运行环境。',
  'settings.fork.runtime.openchamber.title': 'OpenChamber',
  'settings.fork.runtime.openchamber.description': '已加载的服务器和界面修订版本、当前检出、上游发布版本，以及受管理的源码部署状态。',
  'settings.fork.runtime.openchamber.running': '正在运行的服务器修订版本',
  'settings.fork.runtime.openchamber.loadedUi': '已加载的浏览器界面修订版本',
  'settings.fork.runtime.openchamber.loadedUiMismatch': '已加载的浏览器资源与正在运行的服务器修订版本不同。',
  'settings.fork.runtime.openchamber.loadedUiMatches': '已加载的浏览器资源与正在运行的服务器修订版本一致。',
  'settings.fork.runtime.openchamber.loadedUiDirty': '浏览器界面基于包含本地更改的检出内容构建。',
  'settings.fork.runtime.openchamber.loadedUiClean': '浏览器界面基于干净的检出内容构建。',
  'settings.fork.runtime.openchamber.checkout': '已检出的源码修订版本',
  'settings.fork.runtime.openchamber.restartRequired': '重启 OpenChamber 以运行此已检出的修订版本。',
  'settings.fork.runtime.openchamber.customUpstream': '最新自定义上游版本',
  'settings.fork.runtime.openchamber.officialRelease': '最新官方发布版本',
  'settings.fork.runtime.openchamber.updateAction': '拉取并构建最新自定义版本',
  'settings.fork.runtime.openchamber.deployment': '托管源代码部署',
  'settings.fork.runtime.openchamber.rebuildAction': '构建当前签出版本',
  'settings.fork.runtime.openchamber.rebuildDescription': '在暂存环境中构建并验证当前干净的签出版本，然后记录其依赖项和网页资源，以便在下次重启OpenChamber时应用。',
  'settings.fork.runtime.openchamber.sourceCurrent': '源代码签出版本已是最新。',
  'settings.fork.runtime.openchamber.updateDescription': '获取规范的自定义分支，验证可进行干净的快进，在暂存环境中安装依赖项并构建，然后记录已准备的更新。当前使用的源码和资源只会在 OpenChamber 重启时更改。',
  'settings.fork.runtime.openchamber.noUpdate': '检出已是最新状态，或没有安全的托管更新可用。确切原因显示在上方。',
  'settings.fork.runtime.openchamber.restartApplyDescription': '仅重启 OpenChamber 以加载准备好的源码和网页资源。OpenCode 和活动智能体会继续运行。',
  'settings.fork.runtime.openchamber.operation.checking': '正在检查检出状态和权威上游来源',
  'settings.fork.runtime.openchamber.operation.preparing': '正在准备分离式暂存检出',
  'settings.fork.runtime.openchamber.operation.installing': '正在安装暂存的依赖项',
  'settings.fork.runtime.openchamber.operation.building': '正在构建并验证暂存的网页资源',
  'settings.fork.runtime.openchamber.operation.applying': '正在记录已准备的更新，以便进行托管重启',
  'settings.fork.runtime.openchamber.operation.ready': '自定义更新已准备就绪；重启 OpenChamber 以运行该更新',
  'settings.fork.runtime.openchamber.operation.failed': '自定义更新失败；正在运行的修订版本未重启',
