export const settingsDict = {
  ...
  'settings.openchamber.opencodeCli.field.updateInfo': 'Updates only the OpenCode CLI. It does not update OpenChamber or modify Git branches.',
  'settings.openchamber.opencodeCli.state.updateUnavailable': 'This OpenCode runtime cannot be updated here.',
  'settings.openchamber.opencodeCli.state.checkFailed': 'Could not check for OpenCode updates.',
