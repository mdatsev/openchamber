export const settingsDict = {
  ...
  'settings.openchamber.primeAgent.field.binaryPath': 'Prime Agent Binary Path',
  'settings.openchamber.primeAgent.field.binaryPathInfo': 'Choose the Prime Agent executable or launcher. If empty, OpenChamber checks PRIME_AGENT_BINARY and then PATH.',
  'settings.openchamber.primeAgent.actions.browseAria': 'Browse for the Prime Agent executable',
  'settings.openchamber.primeAgent.actions.save': 'Save',
