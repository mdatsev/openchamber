export const settingsDict = {
  ...
  'settings.view.nav.group.fork': 'Custom Fork',
  'settings.page.fork.title': 'Fork Settings',
  'settings.page.fork.description': 'Settings and runtime actions available only in this custom OpenChamber fork.',
  ...
  'settings.fork.restart.label': 'Restart OpenChamber',
  'settings.fork.restart.info': 'Restarts only this OpenChamber interface. OpenCode and active agents continue running, and this page reloads when the interface is available again.',
  'settings.fork.restart.action': 'Restart',
  'settings.fork.restart.checking': 'Checking...',
  'settings.fork.restart.restarting': 'Restarting...',
  'settings.fork.restart.checkAgain': 'Check again',
  'settings.fork.restart.unavailable': 'Unavailable',
  'settings.fork.restart.loadError': 'Could not check whether this runtime supports managed restart.',
  'settings.fork.restart.failed': 'OpenChamber could not be restarted.',
  'settings.fork.restart.timeout': 'OpenChamber is taking longer than expected to restart. Try reloading this page.',
  'settings.fork.opencodeUpdate.label': 'Update OpenCode',
  'settings.fork.opencodeUpdate.info': 'Updates only OpenCode. For the supervised systemd runtime, waits for active agents to finish, then restarts OpenCode. OpenChamber and Git branches are unchanged.',
  'settings.fork.opencodeUpdate.state.updateUnavailable': 'This OpenCode runtime is not managed by this fork.',
  'settings.fork.opencodeUpdate.state.checkFailed': 'Could not check for OpenCode updates.',
  'settings.fork.opencodeUpdate.state.queued': 'Waiting for active agents to finish before updating OpenCode.',
  'settings.fork.opencodeUpdate.state.restarting': 'Restarting OpenCode...',
  'settings.fork.opencodeUpdate.actions.queued': 'Queued',
  'settings.fork.runtime.checking': 'Checking...',
  'settings.fork.runtime.refresh': 'Refresh status',
  'settings.fork.runtime.loadFailed': 'Could not load runtime status.',
  'settings.fork.runtime.actionFailed': 'The runtime action failed.',
  'settings.fork.runtime.cancelFailed': 'The queued operation could not be cancelled.',
  'settings.fork.runtime.unknown': 'Unknown',
  'settings.fork.runtime.unavailable': 'Unavailable',
  'settings.fork.runtime.none': 'None',
  'settings.fork.runtime.current': 'Current with custom upstream',
  'settings.fork.runtime.ahead': '{count} commit(s) ahead of custom upstream',
  'settings.fork.runtime.behind': '{count} commit(s) behind custom upstream',
  'settings.fork.runtime.diverged': 'The histories have diverged; a managed update is blocked.',
  'settings.fork.runtime.comparisonUnknown': 'Comparison with custom upstream is unavailable.',
  'settings.fork.runtime.release': 'Release: {version}',
  'settings.fork.runtime.tag': 'Exact tag: {tag}',
  'settings.fork.runtime.branch': 'Branch: {branch}',
  'settings.fork.runtime.clean': 'Checkout is clean',
  'settings.fork.runtime.dirty': 'Checkout has local changes',
  'settings.fork.runtime.stale': 'This is the last successful result; the latest refresh failed.',
  'settings.fork.runtime.startedAt': 'Process started: {time}',
  'settings.fork.runtime.status.label': 'Status source',
  'settings.fork.runtime.status.checkedAt': 'Checked: {time}',
  'settings.fork.runtime.status.notChecked': 'Status has not been checked yet.',
  'settings.fork.runtime.operation.label': 'Current operation',
  'settings.fork.runtime.operation.idle': 'No operation in progress',
  'settings.fork.runtime.operation.failed': 'Operation failed',
  'settings.fork.runtime.operation.from': 'From commit: {commit}',
  'settings.fork.runtime.operation.target': 'Target commit: {commit}',
  'settings.fork.runtime.operation.updatedAt': 'Last progress update: {time}',
  'settings.fork.runtime.opencode.title': 'OpenCode',
  'settings.fork.runtime.opencode.description': 'Live process, installed executable, public release, and supervised lifecycle state.',
  'settings.fork.runtime.opencode.runningVersion': 'Running / connected version',
  'settings.fork.runtime.opencode.runningVersionDescription': 'Reported by the OpenCode process currently connected to this OpenChamber server.',
  'settings.fork.runtime.opencode.installedVersion': 'Installed executable version',
  'settings.fork.runtime.opencode.installedVersionDescription': 'Read directly from the executable configured for the managed OpenCode service.',
  'settings.fork.runtime.opencode.latestVersion': 'Latest public version',
  'settings.fork.runtime.opencode.latestVersionDescription': 'Highest release reported by the OpenCode npm package and GitHub releases.',
  'settings.fork.runtime.opencode.latestInstalled': 'The connected OpenCode process is on the latest available version.',
  'settings.fork.runtime.opencode.manager': 'Lifecycle manager',
  'settings.fork.runtime.opencode.managerSupported': 'This runtime supports a supervised update. A standalone restart is available for systemd-managed OpenCode.',
  'settings.fork.runtime.opencode.managerUnsupported': 'This OpenCode process is not managed by the connected OpenChamber runtime.',
  'settings.fork.runtime.opencode.activeAgentSingle': '{count} active agent must finish before the operation continues.',
  'settings.fork.runtime.opencode.activeAgentPlural': '{count} active agents must finish before the operation continues.',
  'settings.fork.runtime.opencode.operation.updateQueued': 'Update queued; waiting for active agents',
  'settings.fork.runtime.opencode.operation.restartQueued': 'Restart queued; waiting for active agents',
  'settings.fork.runtime.opencode.operation.updating': 'Installing the latest OpenCode version',
  'settings.fork.runtime.opencode.operation.restarting': 'Restarting OpenCode and reconnecting transports',
  'settings.fork.runtime.opencode.operation.updated': 'OpenCode update completed',
  'settings.fork.runtime.opencode.operation.restarted': 'OpenCode restart completed',
  'settings.fork.runtime.opencode.updateAction': 'Update OpenCode to latest',
  'settings.fork.runtime.opencode.updateAvailable': 'Version {version} is available. Active agents are allowed to finish before the managed restart.',
  'settings.fork.runtime.opencode.noUpdate': 'No newer OpenCode version is currently available.',
  'settings.fork.runtime.opencode.updateUnsupported': 'This runtime cannot update the connected OpenCode process.',
  'settings.fork.runtime.opencode.restartAction': 'Restart OpenCode',
  'settings.fork.runtime.opencode.restartDescription': 'Stops new turns, waits for active agents to finish, restarts the external OpenCode service, and reconnects OpenChamber.',
  'settings.fork.runtime.opencode.restartUnsupported': 'Standalone restart requires the supervised external systemd runtime.',
  'settings.fork.runtime.openchamber.title': 'OpenChamber',
  'settings.fork.runtime.openchamber.description': 'Loaded server and UI revisions, current checkout, upstream releases, and managed source deployment state.',
  'settings.fork.runtime.openchamber.running': 'Running server revision',
  'settings.fork.runtime.openchamber.loadedUi': 'Loaded browser UI revision',
  'settings.fork.runtime.openchamber.loadedUiMismatch': 'The loaded browser assets differ from the running server revision.',
  'settings.fork.runtime.openchamber.loadedUiMatches': 'The loaded browser assets match the running server revision.',
  'settings.fork.runtime.openchamber.loadedUiDirty': 'The browser UI was built from a checkout with local changes.',
  'settings.fork.runtime.openchamber.loadedUiClean': 'The browser UI was built from a clean checkout.',
  'settings.fork.runtime.openchamber.checkout': 'Checked-out source revision',
  'settings.fork.runtime.openchamber.restartRequired': 'Restart OpenChamber to run this checked-out revision.',
  'settings.fork.runtime.openchamber.customUpstream': 'Latest custom upstream',
  'settings.fork.runtime.openchamber.officialRelease': 'Latest official release',
  'settings.fork.runtime.openchamber.updateAction': 'Pull and build latest custom',
  'settings.fork.runtime.openchamber.deployment': 'Managed source deployment',
  'settings.fork.runtime.openchamber.rebuildAction': 'Build current checkout',
  'settings.fork.runtime.openchamber.rebuildDescription': 'Builds and validates the current clean checkout in staging, then records its dependencies and web assets for the next OpenChamber restart.',
  'settings.fork.runtime.openchamber.sourceCurrent': 'The source checkout is up to date.',
  'settings.fork.runtime.openchamber.updateDescription': 'Fetches the canonical custom branch, validates a clean fast-forward, installs dependencies and builds in staging, then records the prepared update. Live source and assets change only when OpenChamber restarts.',
  'settings.fork.runtime.openchamber.noUpdate': 'The checkout is current, or a safe managed update is unavailable. The exact reason is shown above.',
  'settings.fork.runtime.openchamber.restartApplyDescription': 'Restarts only OpenChamber to load the prepared source and web assets. OpenCode and active agents continue running.',
  'settings.fork.runtime.openchamber.operation.checking': 'Checking checkout and upstream authority',
  'settings.fork.runtime.openchamber.operation.preparing': 'Preparing a detached staging checkout',
  'settings.fork.runtime.openchamber.operation.installing': 'Installing staged dependencies',
  'settings.fork.runtime.openchamber.operation.building': 'Building and validating staged web assets',
  'settings.fork.runtime.openchamber.operation.applying': 'Recording the prepared update for managed restart',
  'settings.fork.runtime.openchamber.operation.ready': 'Custom update prepared; restart OpenChamber to run it',
  'settings.fork.runtime.openchamber.operation.failed': 'Custom update failed; the running revision was not restarted',
