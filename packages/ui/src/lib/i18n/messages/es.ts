...
export const dict: Record<I18nKey, string> = {
  ...
  'prime.transcript.readOnly': 'Solo lectura',
  'harness.selector.label': 'Entorno de programación',
  'prime.composer.placeholder': 'Pregunta a Prime Agent...',
  'prime.status.working': 'Trabajando',
  'prime.unavailable.description': 'Prime Agent no está disponible. Configura su ejecutable en los ajustes generales o vuelve a intentar la conexión.',
  'prime.composer.textOnly': 'Prime Agent actualmente solo acepta mensajes de texto.',
  'prime.composer.ambiguous': 'Es posible que Prime Agent haya recibido esta solicitud. Verifica su estado actual antes de volver a intentarlo.',
  'prime.composer.createFailed': 'No se pudo crear la sesión de Prime Agent.',
  'prime.composer.sendFailed': 'No se pudo enviar el mensaje a Prime Agent.',
  'prime.composer.abortFailed': 'No se pudo detener Prime Agent.',
