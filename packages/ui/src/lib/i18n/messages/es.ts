...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.session.status.inputNeeded": "Entrada necesaria",
  "sessions.sidebar.session.status.interruptedUnexpectedly": "Sesión interrumpida inesperadamente",
  ...
  "walkthrough.search.placeholder": "Buscar en los diffs...",
  "walkthrough.search.resultCount": "{current} de {total}",
  "walkthrough.search.previous": "Coincidencia anterior",
  "walkthrough.search.next": "Coincidencia siguiente",
  "walkthrough.search.close": "Cerrar búsqueda",
  ...
  "chat.statusRow.interruptedUnexpectedly": "Interrumpido inesperadamente",
  ...
  "chat.chatInput.placeholder.prime": "Escribe a Prime Agent…",
  "chat.primeComposer.pending": "Actualizando Prime Agent…",
  "chat.primeComposer.outcomeUncertain": "Es posible que Prime Agent haya recibido esa acción. Vuelve a elegir la acción para reintentarla de forma segura.",
  "chat.primeComposer.failed": "Prime Agent no pudo completar esa acción.",
  "chat.primeComposer.draftLimitReached": "Los mensajes tienen un límite de 256 KiB.",
  "chat.draftHarness.pickerAria": "Elegir el entorno del agente",
  "chat.primeDraft.creating": "Creando sesión de Prime Agent…",
  "chat.primeDraft.creationUncertain": "Es posible que la creación haya sido exitosa. Consulta la lista de sesiones antes de volver a intentarlo.",
  "chat.primeDraft.unsupported": "La creación de sesiones de Prime Agent no es compatible con este entorno.",
  "chat.primeDraft.creationFailed": "No se pudo crear la sesión de Prime Agent.",
  "chat.primeDraft.configurationUnavailable": "El modelo o el ajuste de razonamiento seleccionado ya no está disponible desde una sesión de Prime actualizada. Se conservó el borrador.",
  "chat.primeDraft.sourceRefreshFailed": "No se pudieron actualizar las opciones de Prime. Espera un momento e inténtalo de nuevo; se conservó el borrador.",
  "chat.primeDraft.modelControls.defaults": "Valores predeterminados de Prime",
  "chat.primeDraft.modelControls.loadOptions": "Cargar opciones de Prime",
  "chat.primeDraft.modelControls.loadingOptions": "Cargando opciones de Prime…",
  "chat.primeDraft.modelControls.optionsRequireExistingSession": "Las opciones de Prime requieren una sesión de Prime existente",
  "chat.primeDraft.modelControls.primeDefaultThinking": "Razonamiento predeterminado de Prime",
  "chat.primeSession.liveControls.readOnly": "Los controles en vivo están desconectados. La transcripción conservada es de solo lectura.",
  "chat.primeSession.liveControls.reconnect": "Volver a conectar",
  "chat.primeSession.liveControls.enable": "Activar controles en vivo",
  "chat.primeSession.liveControls.reconnecting": "Volviendo a conectar…",
  "chat.primeComposer.liveReconnecting": "Volviendo a conectar los controles en vivo…",
  "chat.primeSession.readOnlyUnavailable": "Esta conversación de Prime Agent es de solo lectura. No se pudo volver a abrir su entorno de ejecución, por lo que el contexto en vivo y los controles de mensajes no están disponibles.",
  ...
  "chat.toolPart.ipythonDiffsOmitted": "Diffs de edición omitidos: {count}",
  ...
  "updateDialog.sourceRun.description": "Esta instalación se está ejecutando desde el código fuente. Fusiona la versión upstream en tu rama personalizada y reinicia OpenChamber.",
  ...
  "updateDialog.actions.mergeUpstreamRelease": "Fusionar versión upstream para actualizar",
  ...
  'chat.container.partialTranscript.description': 'Se muestran los datos de la transcripción disponibles actualmente. Es posible que algunos datos antiguos, demasiado grandes o no disponibles no aparezcan.',
};
