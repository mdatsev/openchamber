...
export const dict = {
  ...
  'sessions.sidebar.group.empty.noSessions': 'Aucune session',
  ...
  'sessions.sidebar.session.moveToWorktree.tooltip': 'Crée un nouveau worktree depuis la branche actuelle et y déplace cette session et ses sous-sessions.',
  ...
  'sessions.sidebar.session.moveToWorktree.confirm.title': 'Déplacer les modifications non validées ?',
  'sessions.sidebar.session.moveToWorktree.confirm.description': 'Ce checkout contient des modifications non validées. Choisissez de les déplacer vers le nouveau worktree ou de les laisser dans le checkout actuel.',
  'sessions.sidebar.session.moveToWorktree.confirm.leaveChanges': 'Laisser les modifications',
  'sessions.sidebar.session.moveToWorktree.confirm.moveChanges': 'Déplacer les modifications',
  ...
  'sessions.sidebar.session.status.linkedWorktree': 'Worktree lié',
  'sessions.sidebar.session.status.worktreeClean': 'Aucune différence avec {branch}',
  ...
  "diffView.scope.branchAgainst": "Modifications par rapport à {branch}",
  "diffView.scope.workingTree": "Arbre de travail",
  "diffView.comparison.mode.uncommitted": "Non validées",
  "diffView.comparison.mode.committed": "Validées",
  "diffView.comparison.mode.combined": "Combinées",
  "diffView.comparison.mode.selectorAria": "Sélectionner le mode de comparaison",
  "diffView.comparison.layer.committed": "Modifications validées",
  "diffView.comparison.layer.staged": "Modifications indexées",
  "diffView.comparison.layer.unstaged": "Modifications non indexées",
  "diffView.comparison.layer.untracked": "Fichiers non suivis",
  "diffView.comparison.layer.combined": "Modifications combinées",
  "diffView.state.loadingBranchChanges": "Chargement des modifications de la branche...",
  "diffView.state.branchLoadFailed": "Impossible de charger les modifications de la branche",
  "diffView.state.noBranchChanges": "Aucune modification par rapport à {branch}",
  "diffView.state.noUncommittedChanges": "Aucune modification non validée",
  "diffView.state.noCommittedChanges": "Aucune modification validée par rapport à {branch}",
  "diffView.state.noCombinedChanges": "Aucune modification validée ou non validée par rapport à {branch}",
  "sessions.sidebar.worktreeChanges": "Fichiers différents de {branch} : {count}",
  ...
  'updateDialog.sourceRun.description': 'Cette installation s’exécute depuis les sources. Demandez à un agent de fusionner la version amont dans votre branche personnalisée, de la valider, puis de redémarrer OpenChamber.',
  ...
  'updateDialog.actions.mergeUpstreamRelease': 'Fusion par agent requise',
