...
export const settingsDict = {
  ...
  'settings.view.nav.group.fork': '사용자 지정 포크',
  'settings.page.fork.title': '포크 설정',
  'settings.page.fork.description': '이 사용자 지정 OpenChamber 포크에서만 사용할 수 있는 설정과 런타임 작업입니다.',
  ...
  'settings.fork.restart.label': 'OpenChamber 다시 시작',
  'settings.fork.restart.info': '이 OpenChamber 인터페이스만 다시 시작합니다. OpenCode와 실행 중인 에이전트는 계속 작동하며, 인터페이스를 다시 사용할 수 있게 되면 이 페이지가 새로고침됩니다.',
  'settings.fork.restart.action': '다시 시작',
  'settings.fork.restart.checking': '확인 중...',
  'settings.fork.restart.restarting': '다시 시작하는 중...',
  'settings.fork.restart.checkAgain': '다시 확인',
  'settings.fork.restart.unavailable': '사용할 수 없음',
  'settings.fork.restart.loadError': '이 런타임이 관리형 다시 시작을 지원하는지 확인할 수 없습니다.',
  'settings.fork.restart.failed': 'OpenChamber를 다시 시작할 수 없습니다.',
  'settings.fork.restart.timeout': 'OpenChamber를 다시 시작하는 데 예상보다 오래 걸리고 있습니다. 이 페이지를 새로고침해 보세요.',
  'settings.fork.opencodeUpdate.label': 'OpenCode 업데이트',
  'settings.fork.opencodeUpdate.info': 'OpenCode만 업데이트합니다. systemd가 감독하는 런타임에서는 활성 에이전트가 완료될 때까지 기다린 다음 OpenCode를 다시 시작합니다. OpenChamber와 Git 브랜치는 변경되지 않습니다.',
  'settings.fork.opencodeUpdate.state.updateUnavailable': '이 OpenCode 런타임은 이 포크에서 관리하지 않습니다.',
  'settings.fork.opencodeUpdate.state.checkFailed': 'OpenCode 업데이트를 확인할 수 없습니다.',
  'settings.fork.opencodeUpdate.state.queued': '활성 에이전트가 완료되면 OpenCode를 업데이트합니다.',
  'settings.fork.opencodeUpdate.state.restarting': 'OpenCode 다시 시작 중...',
  'settings.fork.opencodeUpdate.actions.queued': '대기 중',
  'settings.fork.runtime.checking': '확인 중...',
  'settings.fork.runtime.refresh': '상태 새로 고침',
  'settings.fork.runtime.loadFailed': '런타임 상태를 불러오지 못했습니다.',
  'settings.fork.runtime.actionFailed': '런타임 작업에 실패했습니다.',
  'settings.fork.runtime.cancelFailed': '대기열에 있는 작업을 취소하지 못했습니다.',
  'settings.fork.runtime.unknown': '알 수 없음',
  'settings.fork.runtime.unavailable': '사용할 수 없음',
  'settings.fork.runtime.none': '없음',
  'settings.fork.runtime.current': '사용자 지정 업스트림과 동기화됨',
  'settings.fork.runtime.ahead': '사용자 지정 업스트림보다 커밋 {count}개 앞섬',
  'settings.fork.runtime.behind': '사용자 지정 업스트림보다 커밋 {count}개 뒤처짐',
  'settings.fork.runtime.diverged': '기록이 분기되어 관리형 업데이트가 차단되었습니다.',
  'settings.fork.runtime.comparisonUnknown': '사용자 지정 업스트림과 비교할 수 없습니다.',
  'settings.fork.runtime.release': '릴리스: {version}',
  'settings.fork.runtime.tag': '정확한 태그: {tag}',
  'settings.fork.runtime.branch': '브랜치: {branch}',
  'settings.fork.runtime.clean': '체크아웃에 변경 사항 없음',
  'settings.fork.runtime.dirty': '체크아웃에 로컬 변경 사항이 있음',
  'settings.fork.runtime.stale': '마지막으로 성공한 결과입니다. 최근 새로 고침에 실패했습니다.',
  'settings.fork.runtime.startedAt': '프로세스 시작: {time}',
  'settings.fork.runtime.status.label': '상태 정보 출처',
  'settings.fork.runtime.status.checkedAt': '확인 시각: {time}',
  'settings.fork.runtime.status.notChecked': '아직 상태를 확인하지 않았습니다.',
  'settings.fork.runtime.operation.label': '현재 작업',
  'settings.fork.runtime.operation.idle': '진행 중인 작업 없음',
  'settings.fork.runtime.operation.failed': '작업 실패',
  'settings.fork.runtime.operation.from': '시작 커밋: {commit}',
  'settings.fork.runtime.operation.target': '대상 커밋: {commit}',
  'settings.fork.runtime.operation.updatedAt': '최근 진행 상황 업데이트: {time}',
  'settings.fork.runtime.opencode.title': 'OpenCode',
  'settings.fork.runtime.opencode.description': '실행 중인 프로세스, 설치된 실행 파일, 공개 릴리스 및 관리형 수명 주기 상태입니다.',
  'settings.fork.runtime.opencode.runningVersion': '실행 중 / 연결된 버전',
  'settings.fork.runtime.opencode.runningVersionDescription': '현재 이 OpenChamber 서버에 연결된 OpenCode 프로세스가 보고한 버전입니다.',
  'settings.fork.runtime.opencode.installedVersion': '설치된 실행 파일 버전',
  'settings.fork.runtime.opencode.installedVersionDescription': '관리형 OpenCode 서비스에 설정된 실행 파일에서 직접 읽은 버전입니다.',
  'settings.fork.runtime.opencode.latestVersion': '최신 공개 버전',
  'settings.fork.runtime.opencode.latestVersionDescription': 'OpenCode npm 패키지 및 GitHub 릴리스에서 보고한 가장 높은 버전입니다.',
  'settings.fork.runtime.opencode.latestInstalled': '연결된 OpenCode 프로세스가 사용 가능한 최신 버전을 실행 중입니다.',
  'settings.fork.runtime.opencode.manager': '수명 주기 관리자',
  'settings.fork.runtime.opencode.managerSupported': '이 런타임은 관리형 업데이트를 지원합니다. systemd로 관리되는 OpenCode는 별도로 다시 시작할 수도 있습니다.',
  'settings.fork.runtime.opencode.managerUnsupported': '이 OpenCode 프로세스는 연결된 OpenChamber 런타임에서 관리하지 않습니다.',
  'settings.fork.runtime.opencode.activeAgentSingle': '작업을 계속하려면 활성 에이전트 {count}개가 완료되어야 합니다.',
  'settings.fork.runtime.opencode.activeAgentPlural': '작업을 계속하려면 활성 에이전트 {count}개가 완료되어야 합니다.',
  'settings.fork.runtime.opencode.operation.updateQueued': '업데이트 대기 중, 활성 에이전트가 완료되기를 기다리는 중',
  'settings.fork.runtime.opencode.operation.restartQueued': '다시 시작 대기 중, 활성 에이전트가 완료되기를 기다리는 중',
  'settings.fork.runtime.opencode.operation.updating': '최신 OpenCode 버전 설치 중',
  'settings.fork.runtime.opencode.operation.restarting': 'OpenCode를 다시 시작하고 트랜스포트에 다시 연결하는 중',
  'settings.fork.runtime.opencode.operation.updated': 'OpenCode 업데이트 완료',
  'settings.fork.runtime.opencode.operation.restarted': 'OpenCode 다시 시작 완료',
  'settings.fork.runtime.opencode.updateAction': 'OpenCode를 최신 버전으로 업데이트',
  'settings.fork.runtime.opencode.updateAvailable': '버전 {version}을 사용할 수 있습니다. 관리형 다시 시작 전에 활성 에이전트가 작업을 완료할 때까지 기다립니다.',
  'settings.fork.runtime.opencode.noUpdate': '현재 사용할 수 있는 더 새로운 OpenCode 버전이 없습니다.',
  'settings.fork.runtime.opencode.updateUnsupported': '이 런타임에서는 연결된 OpenCode 프로세스를 업데이트할 수 없습니다.',
  'settings.fork.runtime.opencode.restartAction': 'OpenCode 다시 시작',
  'settings.fork.runtime.opencode.restartDescription': '새 턴 시작을 중지하고 활성 에이전트가 완료되기를 기다린 다음 외부 OpenCode 서비스를 다시 시작하고 OpenChamber를 다시 연결합니다.',
  'settings.fork.runtime.opencode.restartUnsupported': '별도로 다시 시작하려면 관리형 외부 systemd 런타임이 필요합니다.',
  'settings.fork.runtime.openchamber.title': 'OpenChamber',
  'settings.fork.runtime.openchamber.description': '불러온 서버 및 UI 리비전, 현재 체크아웃, 업스트림 릴리스 및 관리형 소스 배포 상태입니다.',
  'settings.fork.runtime.openchamber.running': '실행 중인 서버 리비전',
  'settings.fork.runtime.openchamber.loadedUi': '불러온 브라우저 UI 리비전',
  'settings.fork.runtime.openchamber.loadedUiMismatch': '불러온 브라우저 애셋이 실행 중인 서버 리비전과 다릅니다.',
  'settings.fork.runtime.openchamber.loadedUiMatches': '불러온 브라우저 애셋이 실행 중인 서버 리비전과 일치합니다.',
  'settings.fork.runtime.openchamber.loadedUiDirty': '브라우저 UI는 로컬 변경 사항이 있는 체크아웃에서 빌드되었습니다.',
  'settings.fork.runtime.openchamber.loadedUiClean': '브라우저 UI는 로컬 변경 사항이 없는 체크아웃에서 빌드되었습니다.',
  'settings.fork.runtime.openchamber.checkout': '체크아웃된 소스 리비전',
  'settings.fork.runtime.openchamber.restartRequired': '이 체크아웃된 리비전을 실행하려면 OpenChamber를 다시 시작하세요.',
  'settings.fork.runtime.openchamber.customUpstream': '최신 사용자 지정 업스트림',
  'settings.fork.runtime.openchamber.officialRelease': '최신 공식 릴리스',
  'settings.fork.runtime.openchamber.updateAction': '최신 사용자 지정 버전 가져오기 및 빌드',
  'settings.fork.runtime.openchamber.deployment': '관리형 소스 배포',
  'settings.fork.runtime.openchamber.rebuildAction': '현재 체크아웃 빌드',
  'settings.fork.runtime.openchamber.rebuildDescription': '현재의 깨끗한 체크아웃을 스테이징 환경에서 빌드하고 검증한 뒤 다음 OpenChamber 재시작에 사용할 종속성과 웹 자산을 기록합니다.',
  'settings.fork.runtime.openchamber.sourceCurrent': '소스 체크아웃이 최신 상태입니다.',
  'settings.fork.runtime.openchamber.updateDescription': '기준이 되는 사용자 지정 브랜치를 가져와 안전하게 fast-forward할 수 있는지 확인하고, 스테이징에서 종속성을 설치하고 빌드한 다음 준비된 업데이트를 기록합니다. 실행 중인 소스와 애셋은 OpenChamber를 다시 시작할 때만 변경됩니다.',
  'settings.fork.runtime.openchamber.noUpdate': '체크아웃이 최신 상태이거나 안전한 관리형 업데이트를 사용할 수 없습니다. 정확한 이유는 위에 표시됩니다.',
  'settings.fork.runtime.openchamber.restartApplyDescription': '준비된 소스와 웹 애셋을 불러오기 위해 OpenChamber만 다시 시작합니다. OpenCode와 활성 에이전트는 계속 실행됩니다.',
  'settings.fork.runtime.openchamber.operation.checking': '체크아웃 및 기준 업스트림 확인 중',
  'settings.fork.runtime.openchamber.operation.preparing': '분리된 스테이징 체크아웃 준비 중',
  'settings.fork.runtime.openchamber.operation.installing': '스테이징된 종속성 설치 중',
  'settings.fork.runtime.openchamber.operation.building': '스테이징된 웹 애셋 빌드 및 검증 중',
  'settings.fork.runtime.openchamber.operation.applying': '관리형 재시작을 위해 준비된 업데이트 기록 중',
  'settings.fork.runtime.openchamber.operation.ready': '사용자 지정 업데이트 준비 완료, 실행하려면 OpenChamber를 다시 시작하세요',
  'settings.fork.runtime.openchamber.operation.failed': '사용자 지정 업데이트 실패, 실행 중인 리비전은 다시 시작되지 않았습니다',
