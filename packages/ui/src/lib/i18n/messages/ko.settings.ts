...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.opencodeCli.field.update': 'OpenCode 업데이트',
  'settings.openchamber.opencodeCli.field.updateInfo': 'OpenCode CLI만 업데이트합니다. OpenChamber를 업데이트하거나 Git 브랜치를 수정하지 않습니다.',
  'settings.openchamber.opencodeCli.state.updateUnavailable': '이 OpenCode 런타임은 여기서 업데이트할 수 없습니다.',
  'settings.openchamber.opencodeCli.state.checkFailed': 'OpenCode 업데이트를 확인할 수 없습니다.',
