...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.primeAgent.field.binaryPath': 'Prime Agent 실행 파일 경로',
  'settings.openchamber.primeAgent.field.binaryPathInfo': 'Prime Agent 실행 파일 또는 런처를 선택하세요. 비워 두면 OpenChamber가 PRIME_AGENT_BINARY와 PATH를 차례로 확인합니다.',
  'settings.openchamber.primeAgent.actions.browseAria': 'Prime Agent 실행 파일 찾아보기',
  'settings.openchamber.primeAgent.actions.save': '저장',
