...
export const dict: Record<I18nKey, string> = {
  ...
  'prime.transcript.readOnly': '唯讀',
  'harness.selector.label': '程式開發執行環境',
  'prime.composer.placeholder': '詢問 Prime Agent...',
  'prime.status.working': '處理中',
  'prime.unavailable.description': 'Prime Agent 無法使用。請在一般設定中設定其可執行檔，或重試連線。',
  'prime.composer.textOnly': 'Prime Agent 目前僅接受文字提示。',
  'prime.composer.ambiguous': 'Prime Agent 可能已收到此要求。重試前請先確認其目前狀態。',
  'prime.composer.createFailed': '無法建立 Prime Agent 工作階段。',
  'prime.composer.sendFailed': '無法將提示傳送給 Prime Agent。',
  'prime.composer.abortFailed': '無法停止 Prime Agent。',
