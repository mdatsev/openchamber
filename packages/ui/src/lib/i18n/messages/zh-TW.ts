...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.group.empty.noSessions': '無會話',
  ...
  'sessions.sidebar.session.moveToWorktree.confirm.title': '要移動未提交的變更嗎？',
  'sessions.sidebar.session.moveToWorktree.confirm.description': '此簽出中有未提交的變更。請選擇將其移動到新工作樹，或留在目前的簽出中。',
  'sessions.sidebar.session.moveToWorktree.confirm.leaveChanges': '保留變更',
  'sessions.sidebar.session.moveToWorktree.confirm.moveChanges': '移動變更',
  ...
  'sessions.sidebar.session.status.linkedWorktree': '連結工作樹',
  'sessions.sidebar.session.status.worktreeClean': '與 {branch} 無差異',
  ...
  'gitView.changes.revertFileDescription': '這將捨棄 {path} 的本機變更。此操作無法復原。',
  ...
  "diffView.scope.branchAgainst": "與 {branch} 的差異",
  "diffView.scope.workingTree": "工作區",
  "diffView.comparison.mode.uncommitted": "未提交",
  "diffView.comparison.mode.committed": "已提交",
  "diffView.comparison.mode.combined": "合併顯示",
  "diffView.comparison.mode.selectorAria": "選擇比較模式",
  "diffView.comparison.layer.committed": "已提交的變更",
  "diffView.comparison.layer.staged": "已暫存的變更",
  "diffView.comparison.layer.unstaged": "未暫存的變更",
  "diffView.comparison.layer.untracked": "未追蹤的檔案",
  "diffView.comparison.layer.combined": "合併的變更",
  "diffView.state.loadingBranchChanges": "正在載入分支變更...",
  "diffView.state.branchLoadFailed": "無法載入分支變更",
  "diffView.state.noBranchChanges": "與 {branch} 無差異",
  "diffView.state.noUncommittedChanges": "沒有未提交的變更",
  "diffView.state.noCommittedChanges": "與 {branch} 相比沒有已提交的變更",
  "diffView.state.noCombinedChanges": "與 {branch} 相比沒有已提交或未提交的變更",
  "sessions.sidebar.worktreeChanges": "與 {branch} 不同的檔案：{count}",
  ...
  'updateDialog.sourceRun.description': '此安裝正從原始碼執行。請讓代理將上游版本合併到自訂分支，完成驗證，然後重新啟動 OpenChamber。',
  ...
  'updateDialog.actions.mergeUpstreamRelease': '需要代理合併',
