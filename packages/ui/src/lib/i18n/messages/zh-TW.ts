...
export const dict: Record<I18nKey, string> = {
  ...
  'walkthrough.search.placeholder': '搜尋差異...',
  'walkthrough.search.resultCount': '第 {current} 項，共 {total} 項',
  'walkthrough.search.previous': '上一個符合項目',
  'walkthrough.search.next': '下一個符合項目',
  'walkthrough.search.close': '關閉搜尋',
  ...
  'chat.statusRow.interruptedUnexpectedly': '意外中斷',
  ...
  'chat.chatInput.placeholder.prime': '傳送訊息給 Prime Agent…',
  'chat.primeComposer.pending': '正在更新 Prime Agent…',
  'chat.primeComposer.outcomeUncertain': 'Prime Agent 可能已收到此操作。再次選擇該操作即可安全重試。',
  'chat.primeComposer.failed': 'Prime Agent 無法完成此操作。',
  'chat.primeComposer.draftLimitReached': '訊息大小上限為 256 KiB。',
  "chat.draftHarness.pickerAria": "選擇代理程式框架",
  "chat.primeDraft.creating": "正在建立 Prime Agent 會話…",
  "chat.primeDraft.creationUncertain": "建立可能已成功。再次嘗試前，請先檢查會話清單。",
  "chat.primeDraft.unsupported": "此執行階段不支援建立 Prime Agent 會話。",
  "chat.primeDraft.creationFailed": "無法建立 Prime Agent 會話。",
  "chat.primeDraft.configurationUnavailable": "所選模型或思考設定已無法從最新的 Prime 工作階段取得。草稿已保留。",
  "chat.primeDraft.sourceRefreshFailed": "無法重新整理 Prime 選項。請稍候片刻再試；草稿已保留。",
  "chat.primeDraft.modelControls.defaults": "Prime 預設設定",
  "chat.primeDraft.modelControls.loadOptions": "載入 Prime 選項",
  "chat.primeDraft.modelControls.loadingOptions": "正在載入 Prime 選項…",
  "chat.primeDraft.modelControls.optionsRequireExistingSession": "Prime 選項需要現有的 Prime 工作階段",
  "chat.primeDraft.modelControls.primeDefaultThinking": "Prime 預設思考設定",
  "chat.primeSession.liveControls.readOnly": "即時控制項已中斷連線。保留的會話記錄為唯讀。",
  "chat.primeSession.liveControls.reconnect": "重新連線",
  "chat.primeSession.liveControls.enable": "啟用即時控制項",
  "chat.primeSession.liveControls.reconnecting": "正在重新連線…",
  "chat.primeComposer.liveReconnecting": "正在重新連線即時控制項…",
  'chat.primeSession.readOnlyUnavailable': '此 Prime Agent 對話為唯讀。無法重新開啟其執行階段，因此即時上下文和訊息控制項無法使用。',
  ...
  'chat.toolPart.ipythonDiffsOmitted': '已省略的編輯差異：{count}',
  ...
  'updateDialog.sourceRun.description': '此安裝正從原始碼執行。請將上游版本合併到自訂分支，然後重新啟動 OpenChamber。',
  ...
  'updateDialog.actions.mergeUpstreamRelease': '合併上游版本以更新',
  ...
  'chat.container.partialTranscript.description': '正在顯示目前可用的對話記錄。部分較舊、過大或無法使用的資料可能不會顯示。',
};
