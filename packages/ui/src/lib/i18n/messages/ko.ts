...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.group.empty.noSessions': '세션 없음',
  ...
  'sessions.sidebar.session.moveToWorktree.confirm.title': '커밋되지 않은 변경 사항을 이동할까요?',
  'sessions.sidebar.session.moveToWorktree.confirm.description': '이 체크아웃에 커밋되지 않은 변경 사항이 있습니다. 새 worktree로 이동할지 현재 체크아웃에 남겨 둘지 선택하세요.',
  'sessions.sidebar.session.moveToWorktree.confirm.leaveChanges': '변경 사항 남기기',
  'sessions.sidebar.session.moveToWorktree.confirm.moveChanges': '변경 사항 이동',
  ...
  'sessions.sidebar.session.status.linkedWorktree': '연결된 워크트리',
  'sessions.sidebar.session.status.worktreeClean': '{branch}와 차이 없음',
  ...
  "diffView.scope.branchAgainst": "{branch} 대비 변경 사항",
  "diffView.scope.workingTree": "작업 트리",
  "diffView.comparison.mode.uncommitted": "커밋되지 않음",
  "diffView.comparison.mode.committed": "커밋됨",
  "diffView.comparison.mode.combined": "통합",
  "diffView.comparison.mode.selectorAria": "비교 모드 선택",
  "diffView.comparison.layer.committed": "커밋된 변경 사항",
  "diffView.comparison.layer.staged": "스테이징된 변경 사항",
  "diffView.comparison.layer.unstaged": "스테이징되지 않은 변경 사항",
  "diffView.comparison.layer.untracked": "추적되지 않은 파일",
  "diffView.comparison.layer.combined": "통합된 변경 사항",
  "diffView.state.loadingBranchChanges": "브랜치 변경 사항을 불러오는 중...",
  "diffView.state.branchLoadFailed": "브랜치 변경 사항을 불러오지 못했습니다",
  "diffView.state.noBranchChanges": "{branch} 대비 변경 사항 없음",
  "diffView.state.noUncommittedChanges": "커밋되지 않은 변경 사항이 없습니다",
  "diffView.state.noCommittedChanges": "{branch} 대비 커밋된 변경 사항이 없습니다",
  "diffView.state.noCombinedChanges": "{branch} 대비 커밋되었거나 커밋되지 않은 변경 사항이 없습니다",
  "sessions.sidebar.worktreeChanges": "{branch}와 다른 파일: {count}",
  ...
  'updateDialog.sourceRun.description': '이 설치는 소스에서 실행 중입니다. 에이전트에게 업스트림 릴리스를 사용자 지정 브랜치에 병합하고 검증한 다음 OpenChamber를 다시 시작하도록 요청하세요.',
  ...
  'updateDialog.actions.mergeUpstreamRelease': '에이전트 병합 필요',
