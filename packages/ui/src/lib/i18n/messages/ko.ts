...
export const dict: Record<I18nKey, string> = {
  ...
  'walkthrough.search.placeholder': 'diff 검색...',
  'walkthrough.search.resultCount': '총 {total}개 중 {current}개',
  'walkthrough.search.previous': '이전 일치',
  'walkthrough.search.next': '다음 일치',
  'walkthrough.search.close': '검색 닫기',
  ...
  'chat.statusRow.interruptedUnexpectedly': '예기치 않게 중단됨',
  ...
  'chat.chatInput.placeholder.prime': 'Prime Agent에게 메시지 보내기…',
  'chat.primeComposer.pending': 'Prime Agent 업데이트 중…',
  'chat.primeComposer.outcomeUncertain': 'Prime Agent가 이 작업을 받았을 수 있습니다. 안전하게 다시 시도하려면 같은 작업을 다시 선택하세요.',
  'chat.primeComposer.failed': 'Prime Agent가 이 작업을 완료하지 못했습니다.',
  'chat.primeComposer.draftLimitReached': '메시지는 256 KiB로 제한됩니다.',
  "chat.draftHarness.pickerAria": "에이전트 하네스 선택",
  "chat.primeDraft.creating": "Prime Agent 세션 생성 중…",
  "chat.primeDraft.creationUncertain": "생성에 성공했을 수 있습니다. 다시 시도하기 전에 세션 목록을 확인하세요.",
  "chat.primeDraft.unsupported": "이 런타임에서는 Prime Agent 세션 생성을 지원하지 않습니다.",
  "chat.primeDraft.creationFailed": "Prime Agent 세션을 생성하지 못했습니다.",
  "chat.primeDraft.configurationUnavailable": "선택한 모델 또는 사고 설정을 최신 Prime 세션에서 더 이상 사용할 수 없습니다. 초안은 유지되었습니다.",
  "chat.primeDraft.sourceRefreshFailed": "Prime 옵션을 새로 고칠 수 없습니다. 잠시 후 다시 시도하세요. 초안은 유지되었습니다.",
  "chat.primeDraft.modelControls.defaults": "Prime 기본값",
  "chat.primeDraft.modelControls.loadOptions": "Prime 옵션 불러오기",
  "chat.primeDraft.modelControls.loadingOptions": "Prime 옵션을 불러오는 중…",
  "chat.primeDraft.modelControls.optionsRequireExistingSession": "Prime 옵션을 사용하려면 기존 Prime 세션이 필요합니다",
  "chat.primeDraft.modelControls.primeDefaultThinking": "Prime 기본 사고",
  "chat.primeSession.liveControls.readOnly": "라이브 제어 연결이 끊겼습니다. 유지된 대화 내용은 읽기 전용입니다.",
  "chat.primeSession.liveControls.reconnect": "다시 연결",
  "chat.primeSession.liveControls.enable": "라이브 제어 활성화",
  "chat.primeSession.liveControls.reconnecting": "다시 연결하는 중…",
  "chat.primeComposer.liveReconnecting": "라이브 제어를 다시 연결하는 중…",
  'chat.primeSession.readOnlyUnavailable': '이 Prime Agent 대화는 읽기 전용입니다. 런타임을 다시 열 수 없어 실시간 컨텍스트와 메시지 제어를 사용할 수 없습니다.',
  ...
  'chat.toolPart.ipythonDiffsOmitted': "생략된 편집 diff: {count}",
  ...
  'updateDialog.sourceRun.description': '이 설치는 소스에서 실행 중입니다. 업스트림 릴리스를 사용자 지정 브랜치에 병합한 다음 OpenChamber를 다시 시작하세요.',
  ...
  'updateDialog.actions.mergeUpstreamRelease': '업데이트하려면 업스트림 릴리스 병합',
  ...
  'chat.container.partialTranscript.description': '현재 사용할 수 있는 대화 기록 데이터를 표시합니다. 오래되었거나 너무 크거나 사용할 수 없는 일부 데이터는 표시되지 않을 수 있습니다.',
};
