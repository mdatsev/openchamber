...
export const dict: Record<I18nKey, string> = {
  ...
  'prime.transcript.readOnly': '읽기 전용',
  'harness.selector.label': '코딩 환경',
  'prime.composer.placeholder': 'Prime Agent에게 질문...',
  'prime.status.working': '작업 중',
  'prime.unavailable.description': 'Prime Agent를 사용할 수 없습니다. 일반 설정에서 실행 파일을 구성하거나 연결을 다시 시도하세요.',
  'prime.composer.textOnly': '현재 Prime Agent는 텍스트 프롬프트만 지원합니다.',
  'prime.composer.ambiguous': 'Prime Agent가 이 요청을 받았을 수 있습니다. 다시 시도하기 전에 현재 상태를 확인하세요.',
  'prime.composer.createFailed': 'Prime Agent 세션을 만들지 못했습니다.',
  'prime.composer.sendFailed': 'Prime Agent에 프롬프트를 보내지 못했습니다.',
  'prime.composer.abortFailed': 'Prime Agent를 중지하지 못했습니다.',
