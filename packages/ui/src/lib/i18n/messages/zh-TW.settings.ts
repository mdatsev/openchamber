...
export const settingsDict = {
  ...
  'settings.view.nav.group.fork': '自訂分支',
  'settings.page.fork.title': '分支設定',
  'settings.page.fork.description': '僅在此 OpenChamber 自訂分支中提供的設定和執行環境操作。',
  ...
  'settings.fork.section.runtime': '執行環境',
  'settings.fork.restart.label': '重新啟動 OpenChamber',
  'settings.fork.restart.info': '僅重新啟動此 OpenChamber 介面。OpenCode 和執行中的代理程式會繼續運作，介面恢復可用後，此頁面將自動重新載入。',
  'settings.fork.restart.action': '重新啟動',
  'settings.fork.restart.checking': '正在檢查...',
  'settings.fork.restart.restarting': '正在重新啟動...',
  'settings.fork.restart.checkAgain': '重新檢查',
  'settings.fork.restart.unavailable': '無法使用',
  'settings.fork.restart.loadError': '無法檢查此執行環境是否支援受管理的重新啟動。',
  'settings.fork.restart.failed': '無法重新啟動 OpenChamber。',
  'settings.fork.restart.timeout': 'OpenChamber 的重新啟動時間比預期更久。請嘗試重新載入此頁面。',
  'settings.fork.opencodeUpdate.label': '更新 OpenCode',
  'settings.fork.opencodeUpdate.info': '僅更新 OpenCode。對於由 systemd 監管的執行環境，會等待執行中的代理程式完成後再重新啟動 OpenCode。OpenChamber 和 Git 分支不會變更。',
  'settings.fork.opencodeUpdate.state.updateUnavailable': '此 OpenCode 執行環境不由這個分支管理。',
  'settings.fork.opencodeUpdate.state.checkFailed': '無法檢查 OpenCode 更新。',
  'settings.fork.opencodeUpdate.state.queued': '正在等待執行中的代理程式完成，之後再更新 OpenCode。',
  'settings.fork.opencodeUpdate.state.restarting': '正在重新啟動 OpenCode...',
  'settings.fork.opencodeUpdate.actions.queued': '已排入佇列',
  'settings.fork.runtime.checking': '正在檢查...',
  'settings.fork.runtime.refresh': '重新整理狀態',
  'settings.fork.runtime.loadFailed': '無法載入執行環境狀態。',
  'settings.fork.runtime.actionFailed': '執行環境操作失敗。',
  'settings.fork.runtime.cancelFailed': '無法取消佇列中的操作。',
  'settings.fork.runtime.unknown': '未知',
  'settings.fork.runtime.unavailable': '無法使用',
  'settings.fork.runtime.none': '無',
  'settings.fork.runtime.current': '與自訂上游保持同步',
  'settings.fork.runtime.ahead': '領先自訂上游 {count} 個提交',
  'settings.fork.runtime.behind': '落後自訂上游 {count} 個提交',
  'settings.fork.runtime.diverged': '歷史記錄已分歧；受管理的更新已遭封鎖。',
  'settings.fork.runtime.comparisonUnknown': '無法與自訂上游進行比較。',
  'settings.fork.runtime.release': '發行版本：{version}',
  'settings.fork.runtime.tag': '精確標籤：{tag}',
  'settings.fork.runtime.branch': '分支：{branch}',
  'settings.fork.runtime.clean': '簽出內容沒有變更',
  'settings.fork.runtime.dirty': '簽出內容有本機變更',
  'settings.fork.runtime.stale': '這是上次成功的結果；最新的重新整理失敗。',
  'settings.fork.runtime.startedAt': '處理程序啟動時間：{time}',
  'settings.fork.runtime.status.label': '狀態來源',
  'settings.fork.runtime.status.checkedAt': '檢查時間：{time}',
  'settings.fork.runtime.status.notChecked': '尚未檢查狀態。',
  'settings.fork.runtime.operation.label': '目前操作',
  'settings.fork.runtime.operation.idle': '沒有正在進行的操作',
  'settings.fork.runtime.operation.failed': '操作失敗',
  'settings.fork.runtime.operation.from': '起始提交：{commit}',
  'settings.fork.runtime.operation.target': '目標提交：{commit}',
  'settings.fork.runtime.operation.updatedAt': '上次進度更新時間：{time}',
  'settings.fork.runtime.opencode.title': 'OpenCode',
  'settings.fork.runtime.opencode.description': '即時處理程序、已安裝的可執行檔、公開發行版本，以及受監管的生命週期狀態。',
  'settings.fork.runtime.opencode.runningVersion': '正在執行/已連線的版本',
  'settings.fork.runtime.opencode.runningVersionDescription': '由目前連線至此 OpenChamber 伺服器的 OpenCode 處理程序回報。',
  'settings.fork.runtime.opencode.installedVersion': '已安裝的可執行檔版本',
  'settings.fork.runtime.opencode.installedVersionDescription': '直接從為受管理 OpenCode 服務設定的可執行檔讀取。',
  'settings.fork.runtime.opencode.latestVersion': '最新公開版本',
  'settings.fork.runtime.opencode.latestVersionDescription': 'OpenCode npm 套件和 GitHub 發行版本所回報的最高版本。',
  'settings.fork.runtime.opencode.latestInstalled': '已連線的 OpenCode 處理程序正在執行最新可用版本。',
  'settings.fork.runtime.opencode.manager': '生命週期管理程式',
  'settings.fork.runtime.opencode.managerSupported': '此執行環境支援受監管的更新。由 systemd 管理的 OpenCode 可單獨重新啟動。',
  'settings.fork.runtime.opencode.managerUnsupported': '此 OpenCode 處理程序不受已連線的 OpenChamber 執行環境管理。',
  'settings.fork.runtime.opencode.activeAgentSingle': '有 {count} 個執行中的代理程式必須完成，操作才能繼續。',
  'settings.fork.runtime.opencode.activeAgentPlural': '有 {count} 個執行中的代理程式必須完成，操作才能繼續。',
  'settings.fork.runtime.opencode.operation.updateQueued': '更新已排入佇列；正在等待執行中的代理程式完成',
  'settings.fork.runtime.opencode.operation.restartQueued': '重新啟動已排入佇列；正在等待執行中的代理程式完成',
  'settings.fork.runtime.opencode.operation.updating': '正在安裝最新版本的 OpenCode',
  'settings.fork.runtime.opencode.operation.restarting': '正在重新啟動 OpenCode 並重新連線傳輸通道',
  'settings.fork.runtime.opencode.operation.updated': 'OpenCode 更新完成',
  'settings.fork.runtime.opencode.operation.restarted': 'OpenCode 重新啟動完成',
  'settings.fork.runtime.opencode.updateAction': '將 OpenCode 更新至最新版本',
  'settings.fork.runtime.opencode.updateAvailable': '版本 {version} 可用。受管理的重新啟動會先等待執行中的代理程式完成。',
  'settings.fork.runtime.opencode.noUpdate': '目前沒有更新版本的 OpenCode 可用。',
  'settings.fork.runtime.opencode.updateUnsupported': '此執行環境無法更新已連線的 OpenCode 處理程序。',
  'settings.fork.runtime.opencode.restartAction': '重新啟動 OpenCode',
  'settings.fork.runtime.opencode.restartDescription': '停止接受新的互動輪次，等待執行中的代理程式完成，重新啟動外部 OpenCode 服務，然後重新連線 OpenChamber。',
  'settings.fork.runtime.opencode.restartUnsupported': '單獨重新啟動需要受監管的外部 systemd 執行環境。',
  'settings.fork.runtime.openchamber.title': 'OpenChamber',
  'settings.fork.runtime.openchamber.description': '已載入的伺服器和介面修訂、目前簽出內容、上游發行版本，以及受管理的原始碼部署狀態。',
  'settings.fork.runtime.openchamber.running': '正在執行的伺服器修訂',
  'settings.fork.runtime.openchamber.loadedUi': '已載入的瀏覽器介面修訂',
  'settings.fork.runtime.openchamber.loadedUiMismatch': '已載入的瀏覽器資源與正在執行的伺服器修訂不同。',
  'settings.fork.runtime.openchamber.loadedUiMatches': '已載入的瀏覽器資源與正在執行的伺服器修訂相符。',
  'settings.fork.runtime.openchamber.loadedUiDirty': '瀏覽器介面由含有本機變更的簽出內容建置而成。',
  'settings.fork.runtime.openchamber.loadedUiClean': '瀏覽器介面由乾淨的簽出內容建置而成。',
  'settings.fork.runtime.openchamber.checkout': '已簽出的原始碼修訂',
  'settings.fork.runtime.openchamber.restartRequired': '重新啟動 OpenChamber 以執行此已簽出的修訂。',
  'settings.fork.runtime.openchamber.customUpstream': '最新自訂上游版本',
  'settings.fork.runtime.openchamber.officialRelease': '最新官方發行版本',
  'settings.fork.runtime.openchamber.updateAction': '提取並建置最新自訂版本',
  'settings.fork.runtime.openchamber.deployment': '受管理的來源程式碼部署',
  'settings.fork.runtime.openchamber.rebuildAction': '建置目前簽出版本',
  'settings.fork.runtime.openchamber.rebuildDescription': '在暫存環境中建置並驗證目前乾淨的簽出版本，然後記錄其相依套件與網頁資源，以便在下次重新啟動OpenChamber時套用。',
  'settings.fork.runtime.openchamber.sourceCurrent': '來源程式碼簽出版本已是最新。',
  'settings.fork.runtime.openchamber.updateDescription': '擷取標準自訂分支，驗證可乾淨快轉，在暫存環境中安裝相依套件並建置，然後記錄準備好的更新。目前使用的原始碼和資源只有在 OpenChamber 重新啟動時才會變更。',
  'settings.fork.runtime.openchamber.noUpdate': '簽出內容已是最新狀態，或沒有安全的受管理更新可用。確切原因顯示於上方。',
  'settings.fork.runtime.openchamber.restartApplyDescription': '僅重新啟動 OpenChamber 以載入準備好的原始碼和網頁資源。OpenCode 和執行中的代理程式會繼續運作。',
  'settings.fork.runtime.openchamber.operation.checking': '正在檢查簽出狀態和權威上游來源',
  'settings.fork.runtime.openchamber.operation.preparing': '正在準備分離式暫存簽出',
  'settings.fork.runtime.openchamber.operation.installing': '正在安裝暫存的相依套件',
  'settings.fork.runtime.openchamber.operation.building': '正在建置並驗證暫存的網頁資源',
  'settings.fork.runtime.openchamber.operation.applying': '正在記錄準備好的更新，以便進行受管理的重新啟動',
  'settings.fork.runtime.openchamber.operation.ready': '自訂更新已準備就緒；重新啟動 OpenChamber 以執行該更新',
  'settings.fork.runtime.openchamber.operation.failed': '自訂更新失敗；正在執行的修訂未重新啟動',
