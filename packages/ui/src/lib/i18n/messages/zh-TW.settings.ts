...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.openchamber.primeAgent.field.binaryPath': 'Prime Agent 可執行檔路徑',
  'settings.openchamber.primeAgent.field.binaryPathInfo': '選擇 Prime Agent 可執行檔或啟動器。如果留空，OpenChamber 會依序檢查 PRIME_AGENT_BINARY 與 PATH。',
  'settings.openchamber.primeAgent.actions.browseAria': '瀏覽 Prime Agent 可執行檔',
  'settings.openchamber.primeAgent.actions.save': '儲存',
