...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.openchamber.opencodeCli.field.update': 'OpenCode 更新',
  'settings.openchamber.opencodeCli.field.updateInfo': '只會更新 OpenCode CLI，不會更新 OpenChamber 或修改 Git 分支。',
  'settings.openchamber.opencodeCli.state.updateUnavailable': '無法在此處更新這個 OpenCode 執行環境。',
  'settings.openchamber.opencodeCli.state.checkFailed': '無法檢查 OpenCode 更新。',
