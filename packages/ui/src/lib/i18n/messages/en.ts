...
export const dict = {
  ...
  'prime.transcript.readOnly': 'Read only',
  'harness.selector.label': 'Coding harness',
  'prime.composer.placeholder': 'Ask Prime Agent...',
  'prime.status.working': 'Working',
  'prime.unavailable.description': 'Prime Agent is unavailable. Configure its executable in General settings or retry the connection.',
  'prime.composer.textOnly': 'Prime Agent currently accepts text-only prompts.',
  'prime.composer.ambiguous': 'Prime Agent may have received this request. Verify its current state before trying again.',
  'prime.composer.createFailed': 'Failed to create the Prime Agent session.',
  'prime.composer.sendFailed': 'Failed to send the prompt to Prime Agent.',
  'prime.composer.abortFailed': 'Failed to stop Prime Agent.',
