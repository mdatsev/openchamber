...
export const dict = {
  ...
  'sessions.sidebar.group.empty.noSessions': 'No sessions',
  ...
  'sessions.sidebar.session.moveToWorktree.confirm.title': 'Move uncommitted changes?',
  'sessions.sidebar.session.moveToWorktree.confirm.description': 'This checkout has uncommitted changes. Choose whether to move them to the new worktree or leave them in the current checkout.',
  'sessions.sidebar.session.moveToWorktree.confirm.leaveChanges': 'Leave Changes',
  'sessions.sidebar.session.moveToWorktree.confirm.moveChanges': 'Move Changes',
  ...
  'sessions.sidebar.session.status.linkedWorktree': 'Linked worktree',
  'sessions.sidebar.session.status.worktreeClean': 'No differences from {branch}',
  ...
  'diffView.scope.branchAgainst': 'Changes vs {branch}',
  'diffView.scope.workingTree': 'Working tree',
  'diffView.comparison.mode.uncommitted': 'Uncommitted',
  'diffView.comparison.mode.committed': 'Committed',
  'diffView.comparison.mode.combined': 'Combined',
  'diffView.comparison.mode.selectorAria': 'Select comparison mode',
  'diffView.comparison.layer.committed': 'Committed changes',
  'diffView.comparison.layer.staged': 'Staged changes',
  'diffView.comparison.layer.unstaged': 'Unstaged changes',
  'diffView.comparison.layer.untracked': 'Untracked files',
  'diffView.comparison.layer.combined': 'Combined changes',
  'diffView.state.loadingBranchChanges': 'Loading branch changes...',
  'diffView.state.branchLoadFailed': 'Failed to load branch changes',
  'diffView.state.noBranchChanges': 'No changes from {branch}',
  'diffView.state.noUncommittedChanges': 'No uncommitted changes',
  'diffView.state.noCommittedChanges': 'No committed changes from {branch}',
  'diffView.state.noCombinedChanges': 'No committed or uncommitted changes from {branch}',
  'sessions.sidebar.worktreeChanges': 'Files different from {branch}: {count}',
  ...
  'updateDialog.sourceRun.description': 'This installation is running from source. Ask an agent to merge the upstream release into your custom branch, validate it, and restart OpenChamber.',
  ...
  'updateDialog.actions.mergeUpstreamRelease': 'Agent merge required',
