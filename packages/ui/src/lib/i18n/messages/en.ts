...
export const dict = {
  ...
  'sideChat.label': 'Disposable',
  'sideChat.promote': 'Promote',
  'sideChat.promotion.error': 'Could not promote side chat',
  'sideChat.cleanup.error': 'Could not delete side chat',
  'sideChat.discard.title': 'Discard this side chat?',
  'sideChat.discard.description': 'Active work will be stopped and this conversation will be permanently deleted.',
  'sideChat.discard.sideEffects': 'File changes, commands, and other tool side effects will remain.',
  'sideChat.discard.cancel': 'Keep chat',
  'sideChat.discard.confirm': 'Stop and delete',
  'sideChat.recovery.title': 'Recover side chat?',
  'sideChat.recovery.description': 'OpenChamber found a disposable side chat left by an interrupted cleanup.',
  'sideChat.recovery.sessionLabel': 'Side chat {sessionID}',
  'sideChat.recovery.recover': 'Recover',
  'sideChat.recovery.delete': 'Delete',
  ...
  'walkthrough.search.placeholder': 'Search diffs...',
  'walkthrough.search.resultCount': '{current} of {total}',
  'walkthrough.search.previous': 'Previous match',
  'walkthrough.search.next': 'Next match',
  'walkthrough.search.close': 'Close search',
  ...
  'chat.statusRow.interruptedUnexpectedly': 'Unexpectedly interrupted',
  ...
  'chat.commandAutocomplete.command.sideDescription': 'Open a disposable side chat. It is deleted when closed unless promoted.',
  'chat.commandAutocomplete.command.btwDescription': 'Alias for /side. Opens a disposable chat beside this conversation.',
  ...
  'chat.chatInput.placeholder.prime': 'Message Prime Agent…',
  'chat.primeComposer.pending': 'Updating Prime Agent…',
  'chat.primeComposer.outcomeUncertain': 'Prime Agent may have received that action. Choose the action again to retry safely.',
  'chat.primeComposer.failed': 'Prime Agent could not complete that action.',
  'chat.primeComposer.draftLimitReached': 'Messages are limited to 256 KiB.',
  "chat.draftHarness.pickerAria": "Choose agent harness",
  "chat.primeDraft.creating": "Creating Prime Agent session…",
  "chat.primeDraft.creationUncertain": "Creation may have succeeded. Check the session list before trying again.",
  "chat.primeDraft.unsupported": "Prime Agent session creation is not supported in this runtime.",
  "chat.primeDraft.creationFailed": "Prime Agent session could not be created.",
  "chat.primeDraft.configurationUnavailable": "The selected model or thinking setting is no longer available from a fresh Prime session. Your draft was kept.",
  "chat.primeDraft.sourceRefreshFailed": "Prime options could not be refreshed. Wait a moment and try again; your draft was kept.",
  "chat.primeDraft.modelControls.defaults": "Prime defaults",
  "chat.primeDraft.modelControls.loadOptions": "Load Prime options",
  "chat.primeDraft.modelControls.loadingOptions": "Loading Prime options…",
  "chat.primeDraft.modelControls.optionsRequireExistingSession": "Prime options require an existing Prime session",
  "chat.primeDraft.modelControls.primeDefaultThinking": "Prime default thinking",
  "chat.primeSession.liveControls.readOnly": "Live controls are disconnected. The retained transcript is read-only.",
  "chat.primeSession.liveControls.reconnect": "Reconnect",
  "chat.primeSession.liveControls.enable": "Enable live controls",
  "chat.primeSession.liveControls.reconnecting": "Reconnecting…",
  "chat.primeComposer.liveReconnecting": "Reconnecting live controls…",
  'chat.primeSession.readOnlyUnavailable': 'This Prime Agent conversation is read-only. Its runtime could not be reopened, so live context and message controls are unavailable.',
  ...
  'chat.toolPart.ipythonDiffsOmitted': "Edit diffs omitted: {count}",
  ...
  'updateDialog.sourceRun.description': 'This installation is running from source. Merge the upstream release into your custom branch, then restart OpenChamber.',
  ...
  'updateDialog.actions.mergeUpstreamRelease': 'Merge upstream release to update',
  ...
  'chat.container.partialTranscript.description': 'Showing the transcript data currently available. Some older, oversized, or unavailable data may not be displayed.',
} as const;
