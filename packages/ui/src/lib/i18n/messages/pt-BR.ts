...
export const dict: Record<I18nKey, string> = {
  ...
  "sideChat.label": "Descartável",
  "sideChat.promote": "Preservar",
  "sideChat.promotion.error": "Não foi possível preservar o chat lateral",
  "sideChat.cleanup.error": "Não foi possível excluir o chat lateral",
  "sideChat.discard.title": "Descartar este chat lateral?",
  "sideChat.discard.description": "O trabalho ativo será interrompido e esta conversa será excluída permanentemente.",
  "sideChat.discard.sideEffects": "Alterações em arquivos, comandos e outros efeitos das ferramentas permanecerão.",
  "sideChat.discard.cancel": "Manter chat",
  "sideChat.discard.confirm": "Interromper e excluir",
  "sideChat.recovery.title": "Recuperar chat lateral?",
  "sideChat.recovery.description": "O OpenChamber encontrou um chat lateral descartável deixado por uma limpeza interrompida.",
  "sideChat.recovery.sessionLabel": "Chat lateral {sessionID}",
  "sideChat.recovery.recover": "Recuperar",
  "sideChat.recovery.delete": "Excluir",
  ...
  "walkthrough.search.placeholder": "Pesquisar nos diffs...",
  "walkthrough.search.resultCount": "{current} de {total}",
  "walkthrough.search.previous": "Correspondência anterior",
  "walkthrough.search.next": "Próxima correspondência",
  "walkthrough.search.close": "Fechar pesquisa",
  ...
  "chat.statusRow.interruptedUnexpectedly": "Interrompido inesperadamente",
  ...
  "chat.commandAutocomplete.command.sideDescription": "Abra um chat lateral descartável. Ele será excluído ao fechar, a menos que você o preserve.",
  "chat.commandAutocomplete.command.btwDescription": "Alias de /side. Abre um chat descartável ao lado desta conversa.",
  ...
  "chat.chatInput.placeholder.prime": "Envie uma mensagem para o Prime Agent…",
  "chat.primeComposer.pending": "Atualizando o Prime Agent…",
  "chat.primeComposer.outcomeUncertain": "O Prime Agent pode ter recebido essa ação. Escolha a ação novamente para tentar de forma segura.",
  "chat.primeComposer.failed": "O Prime Agent não conseguiu concluir essa ação.",
  "chat.primeComposer.draftLimitReached": "As mensagens são limitadas a 256 KiB.",
  "chat.draftHarness.pickerAria": "Escolher o ambiente do agente",
  "chat.primeDraft.creating": "Criando sessão do Prime Agent…",
  "chat.primeDraft.creationUncertain": "A criação pode ter sido concluída. Verifique a lista de sessões antes de tentar novamente.",
  "chat.primeDraft.unsupported": "A criação de sessões do Prime Agent não é compatível com este ambiente.",
  "chat.primeDraft.creationFailed": "Não foi possível criar a sessão do Prime Agent.",
  "chat.primeDraft.configurationUnavailable": "O modelo ou a configuração de raciocínio selecionada não está mais disponível em uma sessão Prime atualizada. Seu rascunho foi mantido.",
  "chat.primeDraft.sourceRefreshFailed": "Não foi possível atualizar as opções do Prime. Aguarde um momento e tente novamente; seu rascunho foi mantido.",
  "chat.primeDraft.modelControls.defaults": "Padrões do Prime",
  "chat.primeDraft.modelControls.loadOptions": "Carregar opções do Prime",
  "chat.primeDraft.modelControls.loadingOptions": "Carregando opções do Prime…",
  "chat.primeDraft.modelControls.optionsRequireExistingSession": "As opções do Prime exigem uma sessão do Prime existente",
  "chat.primeDraft.modelControls.primeDefaultThinking": "Raciocínio padrão do Prime",
  "chat.primeSession.liveControls.readOnly": "Os controles ao vivo estão desconectados. A transcrição mantida é somente leitura.",
  "chat.primeSession.liveControls.reconnect": "Reconectar",
  "chat.primeSession.liveControls.enable": "Ativar controles ao vivo",
  "chat.primeSession.liveControls.reconnecting": "Reconectando…",
  "chat.primeComposer.liveReconnecting": "Reconectando os controles ao vivo…",
  "chat.primeSession.readOnlyUnavailable": "Esta conversa do Prime Agent é somente leitura. Não foi possível reabrir o runtime, portanto o contexto ao vivo e os controles de mensagem estão indisponíveis.",
  ...
  "chat.toolPart.ipythonDiffsOmitted": "Diffs de edição omitidos: {count}",
  ...
  "updateDialog.sourceRun.description": "Esta instalação está sendo executada a partir do código-fonte. Mescle a versão upstream na sua branch personalizada e reinicie o OpenChamber.",
  ...
  "updateDialog.actions.mergeUpstreamRelease": "Mesclar versão upstream para atualizar",
  ...
  'chat.container.partialTranscript.description': 'Os dados da transcrição disponíveis no momento estão sendo exibidos. Alguns dados antigos, grandes demais ou indisponíveis podem não aparecer.',
};
