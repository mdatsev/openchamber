...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.group.empty.noSessions": "Nenhuma sessão",
  ...
  "sessions.sidebar.project.status.uncommittedChanges": "Alterações sem commit",
  "sessions.sidebar.project.status.worktreeChanges": "Alterações nas árvores de trabalho",
  ...
  "sessions.sidebar.session.moveToWorktree.tooltip": "Cria um novo worktree a partir da branch atual e move esta sessão e suas subsessões para lá.",
  ...
  "sessions.sidebar.session.moveToWorktree.confirm.title": "Mover alterações não commitadas?",
  "sessions.sidebar.session.moveToWorktree.confirm.description": "Este checkout tem alterações não commitadas. Escolha se deseja movê-las para o novo worktree ou deixá-las no checkout atual.",
  "sessions.sidebar.session.moveToWorktree.confirm.leaveChanges": "Deixar alterações",
  "sessions.sidebar.session.moveToWorktree.confirm.moveChanges": "Mover alterações",
  ...
  "sessions.sidebar.session.status.linkedWorktree": "Worktree vinculado",
  "sessions.sidebar.session.status.worktreeClean": "Sem diferenças em relação a {branch}",
  ...
  "gitView.changes.revertFileDescription": "As alterações locais em {path} serão descartadas. Esta ação não pode ser desfeita.",
  ...
  "diffView.scope.branchAgainst": "Alterações em relação a {branch}",
  "diffView.scope.workingTree": "Árvore de trabalho",
  "diffView.comparison.mode.uncommitted": "Não commitadas",
  "diffView.comparison.mode.committed": "Commitadas",
  "diffView.comparison.mode.combined": "Combinadas",
  "diffView.comparison.mode.selectorAria": "Selecionar modo de comparação",
  "diffView.comparison.layer.committed": "Alterações commitadas",
  "diffView.comparison.layer.staged": "Alterações preparadas",
  "diffView.comparison.layer.unstaged": "Alterações não preparadas",
  "diffView.comparison.layer.untracked": "Arquivos não rastreados",
  "diffView.comparison.layer.combined": "Alterações combinadas",
  "diffView.state.loadingBranchChanges": "Carregando alterações da branch...",
  "diffView.state.branchLoadFailed": "Não foi possível carregar as alterações da branch",
  "diffView.state.noBranchChanges": "Nenhuma alteração em relação a {branch}",
  "diffView.state.noUncommittedChanges": "Nenhuma alteração não commitada",
  "diffView.state.noCommittedChanges": "Nenhuma alteração commitada em relação a {branch}",
  "diffView.state.noCombinedChanges": "Nenhuma alteração commitada ou não commitada em relação a {branch}",
  "sessions.sidebar.worktreeChanges": "Arquivos diferentes de {branch}: {count}",
  ...
  "updateDialog.sourceRun.description": "Esta instalação está sendo executada a partir do código-fonte. Peça a um agente para mesclar a versão upstream na sua branch personalizada, validá-la e reiniciar o OpenChamber.",
  ...
  "updateDialog.actions.mergeUpstreamRelease": "Merge por agente necessário",
