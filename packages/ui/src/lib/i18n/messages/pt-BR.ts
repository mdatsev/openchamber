...
export const dict: Record<I18nKey, string> = {
  ...
  'prime.transcript.readOnly': 'Somente leitura',
  'harness.selector.label': 'Ambiente de programação',
  'prime.composer.placeholder': 'Pergunte ao Prime Agent...',
  'prime.status.working': 'Trabalhando',
  'prime.unavailable.description': 'O Prime Agent está indisponível. Configure o executável nos ajustes gerais ou tente conectar novamente.',
  'prime.composer.textOnly': 'No momento, o Prime Agent aceita apenas prompts de texto.',
  'prime.composer.ambiguous': 'O Prime Agent pode ter recebido esta solicitação. Verifique o estado atual antes de tentar novamente.',
  'prime.composer.createFailed': 'Não foi possível criar a sessão do Prime Agent.',
  'prime.composer.sendFailed': 'Não foi possível enviar o prompt ao Prime Agent.',
  'prime.composer.abortFailed': 'Não foi possível interromper o Prime Agent.',
