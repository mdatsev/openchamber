...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.openchamber.opencodeCli.field.update": "Оновлення OpenCode",
  "settings.openchamber.opencodeCli.field.updateInfo": "Оновлює лише OpenCode CLI. Не оновлює OpenChamber і не змінює гілки Git.",
  "settings.openchamber.opencodeCli.state.updateUnavailable": "Це середовище OpenCode не можна оновити тут.",
  "settings.openchamber.opencodeCli.state.checkFailed": "Не вдалося перевірити наявність оновлень OpenCode.",
