...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  'settings.openchamber.primeAgent.field.binaryPath': 'Шлях до виконуваного файла Prime Agent',
  'settings.openchamber.primeAgent.field.binaryPathInfo': 'Виберіть виконуваний файл або засіб запуску Prime Agent. Якщо поле порожнє, OpenChamber перевіряє PRIME_AGENT_BINARY, а потім PATH.',
  'settings.openchamber.primeAgent.actions.browseAria': 'Вибрати виконуваний файл Prime Agent',
  'settings.openchamber.primeAgent.actions.save': 'Зберегти',
