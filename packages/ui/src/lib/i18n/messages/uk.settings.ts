...
export const settingsDict = {
  ...
  "settings.view.nav.group.fork": "Користувацький форк",
  "settings.page.fork.title": "Налаштування форку",
  "settings.page.fork.description": "Налаштування та дії середовища, доступні лише в цьому користувацькому форку OpenChamber.",
  ...
  "settings.fork.restart.label": "Перезапустити OpenChamber",
  "settings.fork.restart.info": "Перезапускає лише цей інтерфейс OpenChamber. OpenCode та активні агенти продовжують працювати, а ця сторінка перезавантажиться, коли інтерфейс знову стане доступним.",
  "settings.fork.restart.action": "Перезапустити",
  "settings.fork.restart.checking": "Перевірка...",
  "settings.fork.restart.restarting": "Перезапуск...",
  "settings.fork.restart.checkAgain": "Перевірити ще раз",
  "settings.fork.restart.unavailable": "Недоступно",
  "settings.fork.restart.loadError": "Не вдалося перевірити, чи підтримує це середовище керований перезапуск.",
  "settings.fork.restart.failed": "Не вдалося перезапустити OpenChamber.",
  "settings.fork.restart.timeout": "Перезапуск OpenChamber триває довше, ніж очікувалося. Спробуйте перезавантажити цю сторінку.",
  "settings.fork.opencodeUpdate.label": "Оновити OpenCode",
  "settings.fork.opencodeUpdate.info": "Оновлює лише OpenCode. У середовищі під наглядом systemd очікує завершення активних агентів, а потім перезапускає OpenCode. OpenChamber і гілки Git не змінюються.",
  "settings.fork.opencodeUpdate.state.updateUnavailable": "Це середовище OpenCode не керується цим форком.",
  "settings.fork.opencodeUpdate.state.checkFailed": "Не вдалося перевірити наявність оновлень OpenCode.",
  "settings.fork.opencodeUpdate.state.queued": "Очікування завершення активних агентів перед оновленням OpenCode.",
  "settings.fork.opencodeUpdate.state.restarting": "Перезапуск OpenCode...",
  "settings.fork.opencodeUpdate.actions.queued": "У черзі",
  "settings.fork.runtime.checking": "Перевірка...",
  "settings.fork.runtime.refresh": "Оновити статус",
  "settings.fork.runtime.loadFailed": "Не вдалося завантажити статус середовища виконання.",
  "settings.fork.runtime.actionFailed": "Не вдалося виконати дію в середовищі виконання.",
  "settings.fork.runtime.cancelFailed": "Не вдалося скасувати операцію в черзі.",
  "settings.fork.runtime.unknown": "Невідомо",
  "settings.fork.runtime.unavailable": "Недоступно",
  "settings.fork.runtime.none": "Немає",
  "settings.fork.runtime.current": "Відповідає користувацькому upstream",
  "settings.fork.runtime.ahead": "Комітів попереду користувацького upstream: {count}",
  "settings.fork.runtime.behind": "Комітів позаду користувацького upstream: {count}",
  "settings.fork.runtime.diverged": "Історії розійшлися; кероване оновлення заблоковано.",
  "settings.fork.runtime.comparisonUnknown": "Порівняння з користувацьким upstream недоступне.",
  "settings.fork.runtime.release": "Реліз: {version}",
  "settings.fork.runtime.tag": "Точний тег: {tag}",
  "settings.fork.runtime.branch": "Гілка: {branch}",
  "settings.fork.runtime.clean": "У checkout немає змін",
  "settings.fork.runtime.dirty": "У checkout є локальні зміни",
  "settings.fork.runtime.stale": "Це останній успішний результат; остання спроба оновити статус не вдалася.",
  "settings.fork.runtime.startedAt": "Процес запущено: {time}",
  "settings.fork.runtime.status.label": "Джерело статусу",
  "settings.fork.runtime.status.checkedAt": "Перевірено: {time}",
  "settings.fork.runtime.status.notChecked": "Статус ще не перевірявся.",
  "settings.fork.runtime.operation.label": "Поточна операція",
  "settings.fork.runtime.operation.idle": "Немає активних операцій",
  "settings.fork.runtime.operation.failed": "Операція завершилася помилкою",
  "settings.fork.runtime.operation.from": "Початковий коміт: {commit}",
  "settings.fork.runtime.operation.target": "Цільовий коміт: {commit}",
  "settings.fork.runtime.operation.updatedAt": "Останнє оновлення прогресу: {time}",
  "settings.fork.runtime.opencode.title": "OpenCode",
  "settings.fork.runtime.opencode.description": "Активний процес, встановлений виконуваний файл, публічний реліз і стан контрольованого життєвого циклу.",
  "settings.fork.runtime.opencode.runningVersion": "Запущена / підключена версія",
  "settings.fork.runtime.opencode.runningVersionDescription": "Цю версію повідомляє процес OpenCode, наразі підключений до цього сервера OpenChamber.",
  "settings.fork.runtime.opencode.installedVersion": "Версія встановленого виконуваного файлу",
  "settings.fork.runtime.opencode.installedVersionDescription": "Зчитано безпосередньо з виконуваного файлу, налаштованого для керованої служби OpenCode.",
  "settings.fork.runtime.opencode.latestVersion": "Найновіша публічна версія",
  "settings.fork.runtime.opencode.latestVersionDescription": "Найновіший реліз за даними пакета OpenCode у npm і релізів GitHub.",
  "settings.fork.runtime.opencode.latestInstalled": "Підключений процес OpenCode використовує найновішу доступну версію.",
  "settings.fork.runtime.opencode.manager": "Менеджер життєвого циклу",
  "settings.fork.runtime.opencode.managerSupported": "Це середовище підтримує контрольоване оновлення. Окремий перезапуск доступний для OpenCode під керуванням systemd.",
  "settings.fork.runtime.opencode.managerUnsupported": "Цей процес OpenCode не керується підключеним середовищем OpenChamber.",
  "settings.fork.runtime.opencode.activeAgentSingle": "Щоб операція продовжилася, {count} активний агент має завершити роботу.",
  "settings.fork.runtime.opencode.activeAgentPlural": "Операція продовжиться після завершення активних агентів ({count}).",
  "settings.fork.runtime.opencode.operation.updateQueued": "Оновлення в черзі; очікування завершення активних агентів",
  "settings.fork.runtime.opencode.operation.restartQueued": "Перезапуск у черзі; очікування завершення активних агентів",
  "settings.fork.runtime.opencode.operation.updating": "Встановлення найновішої версії OpenCode",
  "settings.fork.runtime.opencode.operation.restarting": "Перезапуск OpenCode і повторне підключення транспортів",
  "settings.fork.runtime.opencode.operation.updated": "Оновлення OpenCode завершено",
  "settings.fork.runtime.opencode.operation.restarted": "Перезапуск OpenCode завершено",
  "settings.fork.runtime.opencode.updateAction": "Оновити OpenCode до найновішої версії",
  "settings.fork.runtime.opencode.updateAvailable": "Доступна версія {version}. Перед керованим перезапуском активним агентам буде надано час завершити роботу.",
  "settings.fork.runtime.opencode.noUpdate": "Наразі немає новішої версії OpenCode.",
  "settings.fork.runtime.opencode.updateUnsupported": "Це середовище не може оновити підключений процес OpenCode.",
  "settings.fork.runtime.opencode.restartAction": "Перезапустити OpenCode",
  "settings.fork.runtime.opencode.restartDescription": "Припиняє обробку нових запитів, очікує завершення активних агентів, перезапускає зовнішню службу OpenCode та повторно підключає OpenChamber.",
  "settings.fork.runtime.opencode.restartUnsupported": "Для окремого перезапуску потрібне зовнішнє середовище під наглядом systemd.",
  "settings.fork.runtime.openchamber.title": "OpenChamber",
  "settings.fork.runtime.openchamber.description": "Завантажені ревізії сервера й інтерфейсу, поточний checkout, upstream-релізи та стан керованого розгортання з вихідного коду.",
  "settings.fork.runtime.openchamber.running": "Запущена ревізія сервера",
  "settings.fork.runtime.openchamber.loadedUi": "Завантажена ревізія браузерного інтерфейсу",
  "settings.fork.runtime.openchamber.loadedUiMismatch": "Завантажені ресурси браузера відрізняються від запущеної ревізії сервера.",
  "settings.fork.runtime.openchamber.loadedUiMatches": "Завантажені ресурси браузера відповідають запущеній ревізії сервера.",
  "settings.fork.runtime.openchamber.loadedUiDirty": "Браузерний інтерфейс зібрано з checkout, що містить локальні зміни.",
  "settings.fork.runtime.openchamber.loadedUiClean": "Браузерний інтерфейс зібрано з чистого checkout.",
  "settings.fork.runtime.openchamber.checkout": "Ревізія вихідного коду в checkout",
  "settings.fork.runtime.openchamber.restartRequired": "Перезапустіть OpenChamber, щоб запустити цю ревізію з checkout.",
  "settings.fork.runtime.openchamber.customUpstream": "Найновіший користувацький upstream",
  "settings.fork.runtime.openchamber.officialRelease": "Найновіший офіційний реліз",
  "settings.fork.runtime.openchamber.updateAction": "Отримати й зібрати найновішу користувацьку версію",
  "settings.fork.runtime.openchamber.deployment": "Кероване розгортання вихідного коду",
  "settings.fork.runtime.openchamber.rebuildAction": "Зібрати поточний checkout",
  "settings.fork.runtime.openchamber.rebuildDescription": "Збирає та перевіряє поточний чистий checkout у проміжному середовищі, а потім зберігає його залежності й вебресурси для наступного перезапуску OpenChamber.",
  "settings.fork.runtime.openchamber.sourceCurrent": "Checkout вихідного коду актуальний.",
  "settings.fork.runtime.openchamber.updateDescription": "Отримує канонічну користувацьку гілку, перевіряє можливість чистого fast-forward, встановлює залежності та виконує збірку в staging, а потім записує підготовлене оновлення. Поточний вихідний код і ресурси змінюються лише під час перезапуску OpenChamber.",
  "settings.fork.runtime.openchamber.noUpdate": "Checkout актуальний або безпечне кероване оновлення недоступне. Точну причину наведено вище.",
  "settings.fork.runtime.openchamber.restartApplyDescription": "Перезапускає лише OpenChamber, щоб завантажити підготовлений вихідний код і вебресурси. OpenCode й активні агенти продовжують працювати.",
  "settings.fork.runtime.openchamber.operation.checking": "Перевірка checkout і канонічного upstream",
  "settings.fork.runtime.openchamber.operation.preparing": "Підготовка відокремленого staging-checkout",
  "settings.fork.runtime.openchamber.operation.installing": "Встановлення підготовлених залежностей",
  "settings.fork.runtime.openchamber.operation.building": "Збирання та перевірка підготовлених вебресурсів",
  "settings.fork.runtime.openchamber.operation.applying": "Запис підготовленого оновлення для керованого перезапуску",
  "settings.fork.runtime.openchamber.operation.ready": "Користувацьке оновлення підготовлено; перезапустіть OpenChamber, щоб запустити його",
  "settings.fork.runtime.openchamber.operation.failed": "Не вдалося виконати користувацьке оновлення; запущену ревізію не було перезапущено",
