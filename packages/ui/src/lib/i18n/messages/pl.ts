...
export const dict: Record<I18nKey, string> = {
  ...
  'prime.transcript.readOnly': 'Tylko do odczytu',
  'harness.selector.label': 'Środowisko programistyczne',
  'prime.composer.placeholder': 'Zapytaj Prime Agent...',
  'prime.status.working': 'Pracuje',
  'prime.unavailable.description': 'Prime Agent jest niedostępny. Skonfiguruj plik wykonywalny w ustawieniach ogólnych lub ponów połączenie.',
  'prime.composer.textOnly': 'Prime Agent obsługuje obecnie tylko monity tekstowe.',
  'prime.composer.ambiguous': 'Prime Agent mógł otrzymać to żądanie. Sprawdź jego bieżący stan przed ponowną próbą.',
  'prime.composer.createFailed': 'Nie udało się utworzyć sesji Prime Agent.',
  'prime.composer.sendFailed': 'Nie udało się wysłać monitu do Prime Agent.',
  'prime.composer.abortFailed': 'Nie udało się zatrzymać Prime Agent.',
