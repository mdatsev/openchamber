...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.session.status.inputNeeded': 'Wymagane wejście',
  'sessions.sidebar.session.status.interruptedUnexpectedly': 'Sesja została nieoczekiwanie przerwana',
  ...
  'chat.statusRow.interruptedUnexpectedly': 'Nieoczekiwanie przerwane',
  ...
  'chat.chatInput.placeholder.prime': 'Napisz do Prime Agent…',
  'chat.primeComposer.pending': 'Aktualizowanie Prime Agent…',
  'chat.primeComposer.outcomeUncertain': 'Prime Agent mógł odebrać tę czynność. Wybierz ją ponownie, aby bezpiecznie ponowić próbę.',
  'chat.primeComposer.failed': 'Prime Agent nie mógł ukończyć tej czynności.',
  'chat.primeComposer.draftLimitReached': 'Wiadomości są ograniczone do 256 KiB.',
  "chat.draftHarness.pickerAria": "Wybierz środowisko agenta",
  "chat.primeDraft.creating": "Tworzenie sesji Prime Agent…",
  "chat.primeDraft.creationUncertain": "Tworzenie mogło się powieść. Przed ponowną próbą sprawdź listę sesji.",
  "chat.primeDraft.unsupported": "Tworzenie sesji Prime Agent nie jest obsługiwane w tym środowisku.",
  "chat.primeDraft.creationFailed": "Nie udało się utworzyć sesji Prime Agent.",
  "chat.primeDraft.configurationUnavailable": "Wybrany model lub poziom rozumowania nie jest już dostępny w aktualnej sesji Prime. Szkic został zachowany.",
  "chat.primeDraft.sourceRefreshFailed": "Nie udało się odświeżyć opcji Prime. Poczekaj chwilę i spróbuj ponownie; szkic został zachowany.",
  "chat.primeDraft.modelControls.defaults": "Ustawienia domyślne Prime",
  "chat.primeDraft.modelControls.loadOptions": "Wczytaj opcje Prime",
  "chat.primeDraft.modelControls.loadingOptions": "Wczytywanie opcji Prime…",
  "chat.primeDraft.modelControls.optionsRequireExistingSession": "Opcje Prime wymagają istniejącej sesji Prime",
  "chat.primeDraft.modelControls.primeDefaultThinking": "Domyślne rozumowanie Prime",
  "chat.primeSession.liveControls.readOnly": "Sterowanie na żywo jest rozłączone. Zachowany zapis rozmowy jest tylko do odczytu.",
  "chat.primeSession.liveControls.reconnect": "Połącz ponownie",
  "chat.primeSession.liveControls.enable": "Włącz sterowanie na żywo",
  "chat.primeSession.liveControls.reconnecting": "Ponowne łączenie…",
  "chat.primeComposer.liveReconnecting": "Ponowne łączenie sterowania na żywo…",
  'chat.primeSession.readOnlyUnavailable': 'Ta rozmowa Prime Agent jest tylko do odczytu. Nie udało się ponownie otworzyć jej środowiska wykonawczego, więc kontekst na żywo i sterowanie wiadomościami są niedostępne.',
  ...
  'chat.toolPart.ipythonDiffsOmitted': "Pominięte różnice edycji: {count}",
  ...
  'walkthrough.search.placeholder': 'Przeszukaj różnice...',
  'walkthrough.search.resultCount': '{current} z {total}',
  'walkthrough.search.previous': 'Poprzednie dopasowanie',
  'walkthrough.search.next': 'Następne dopasowanie',
  'walkthrough.search.close': 'Zamknij wyszukiwanie',
  ...
  'updateDialog.actions.mergeUpstreamRelease': 'Scal wydanie upstream, aby zaktualizować',
  ...
  'updateDialog.sourceRun.description': 'Ta instalacja jest uruchomiona ze źródeł. Scal wydanie upstream z własną gałęzią, a następnie uruchom ponownie OpenChamber.',
  ...
  'chat.container.partialTranscript.description': 'Wyświetlane są obecnie dostępne dane transkrypcji. Niektóre starsze, zbyt duże lub niedostępne dane mogą nie zostać pokazane.',
} as const;
