...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.openchamber.opencodeCli.field.update": "Atualização do OpenCode",
  "settings.openchamber.opencodeCli.field.updateInfo": "Atualiza somente a CLI do OpenCode. Não atualiza o OpenChamber nem modifica branches do Git.",
  "settings.openchamber.opencodeCli.state.updateUnavailable": "Este ambiente do OpenCode não pode ser atualizado aqui.",
  "settings.openchamber.opencodeCli.state.checkFailed": "Não foi possível verificar atualizações do OpenCode.",
