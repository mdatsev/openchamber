...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  'settings.openchamber.primeAgent.field.binaryPath': 'Caminho do executável do Prime Agent',
  'settings.openchamber.primeAgent.field.binaryPathInfo': 'Escolha o executável ou inicializador do Prime Agent. Se o campo ficar vazio, o OpenChamber verifica PRIME_AGENT_BINARY e depois PATH.',
  'settings.openchamber.primeAgent.actions.browseAria': 'Buscar o executável do Prime Agent',
  'settings.openchamber.primeAgent.actions.save': 'Salvar',
