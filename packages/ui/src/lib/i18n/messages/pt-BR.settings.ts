...
export const settingsDict = {
  ...
  "settings.view.nav.group.fork": "Fork personalizado",
  "settings.page.fork.title": "Configurações do fork",
  "settings.page.fork.description": "Configurações e ações de ambiente disponíveis apenas neste fork personalizado do OpenChamber.",
  "settings.fork.section.worktrees": "Worktrees",
  "settings.fork.startNewChatInWorktree.label": "Iniciar novos chats no worktree atual",
  "settings.fork.startNewChatInWorktree.info": "Ao iniciar um novo chat em um worktree, usa esse worktree em vez do checkout principal do projeto. Projetos e worktrees selecionados explicitamente não são alterados.",
  "settings.fork.section.runtime": "Ambiente de execução",
  "settings.fork.restart.label": "Reiniciar o OpenChamber",
  "settings.fork.restart.info": "Reinicia apenas esta interface do OpenChamber. O OpenCode e os agentes ativos continuam em execução, e esta página é recarregada quando a interface fica disponível novamente.",
  "settings.fork.restart.action": "Reiniciar",
  "settings.fork.restart.checking": "Verificando...",
  "settings.fork.restart.restarting": "Reiniciando...",
  "settings.fork.restart.checkAgain": "Verificar novamente",
  "settings.fork.restart.unavailable": "Indisponível",
  "settings.fork.restart.loadError": "Não foi possível verificar se este ambiente oferece suporte à reinicialização gerenciada.",
  "settings.fork.restart.failed": "Não foi possível reiniciar o OpenChamber.",
  "settings.fork.restart.timeout": "O OpenChamber está demorando mais do que o esperado para reiniciar. Tente recarregar esta página.",
  "settings.fork.opencodeUpdate.label": "Atualizar o OpenCode",
  "settings.fork.opencodeUpdate.info": "Atualiza apenas o OpenCode. No ambiente supervisionado pelo systemd, aguarda os agentes ativos terminarem e depois reinicia o OpenCode. O OpenChamber e as branches do Git não são alterados.",
  "settings.fork.opencodeUpdate.state.updateUnavailable": "Este ambiente do OpenCode não é gerenciado por este fork.",
  "settings.fork.opencodeUpdate.state.checkFailed": "Não foi possível verificar atualizações do OpenCode.",
  "settings.fork.opencodeUpdate.state.queued": "Aguardando os agentes ativos terminarem antes de atualizar o OpenCode.",
  "settings.fork.opencodeUpdate.state.restarting": "Reiniciando o OpenCode...",
  "settings.fork.opencodeUpdate.actions.queued": "Na fila",
  "settings.fork.runtime.checking": "Verificando...",
  "settings.fork.runtime.refresh": "Atualizar status",
  "settings.fork.runtime.loadFailed": "Não foi possível carregar o status do ambiente de execução.",
  "settings.fork.runtime.actionFailed": "A ação do ambiente de execução falhou.",
  "settings.fork.runtime.cancelFailed": "Não foi possível cancelar a operação na fila.",
  "settings.fork.runtime.unknown": "Desconhecido",
  "settings.fork.runtime.unavailable": "Indisponível",
  "settings.fork.runtime.none": "Nenhum",
  "settings.fork.runtime.current": "Atual em relação ao upstream personalizado",
  "settings.fork.runtime.ahead": "Commits à frente do upstream personalizado: {count}",
  "settings.fork.runtime.behind": "Commits atrás do upstream personalizado: {count}",
  "settings.fork.runtime.diverged": "Os históricos divergiram; a atualização gerenciada está bloqueada.",
  "settings.fork.runtime.comparisonUnknown": "A comparação com o upstream personalizado não está disponível.",
  "settings.fork.runtime.release": "Versão lançada: {version}",
  "settings.fork.runtime.tag": "Tag exata: {tag}",
  "settings.fork.runtime.branch": "Ramificação: {branch}",
  "settings.fork.runtime.clean": "O checkout está limpo",
  "settings.fork.runtime.dirty": "O checkout tem alterações locais",
  "settings.fork.runtime.stale": "Este é o último resultado bem-sucedido; a tentativa mais recente de atualizar o status falhou.",
  "settings.fork.runtime.startedAt": "Processo iniciado: {time}",
  "settings.fork.runtime.status.label": "Origem do status",
  "settings.fork.runtime.status.checkedAt": "Verificado em: {time}",
  "settings.fork.runtime.status.notChecked": "O status ainda não foi verificado.",
  "settings.fork.runtime.operation.label": "Operação atual",
  "settings.fork.runtime.operation.idle": "Nenhuma operação em andamento",
  "settings.fork.runtime.operation.failed": "A operação falhou",
  "settings.fork.runtime.operation.from": "Commit de origem: {commit}",
  "settings.fork.runtime.operation.target": "Commit de destino: {commit}",
  "settings.fork.runtime.operation.updatedAt": "Última atualização do progresso: {time}",
  "settings.fork.runtime.opencode.title": "OpenCode",
  "settings.fork.runtime.opencode.description": "Processo ativo, executável instalado, versão pública e estado supervisionado do ciclo de vida.",
  "settings.fork.runtime.opencode.runningVersion": "Versão em execução / conectada",
  "settings.fork.runtime.opencode.runningVersionDescription": "Informada pelo processo do OpenCode conectado atualmente a este servidor OpenChamber.",
  "settings.fork.runtime.opencode.installedVersion": "Versão do executável instalado",
  "settings.fork.runtime.opencode.installedVersionDescription": "Lida diretamente do executável configurado para o serviço gerenciado do OpenCode.",
  "settings.fork.runtime.opencode.latestVersion": "Versão pública mais recente",
  "settings.fork.runtime.opencode.latestVersionDescription": "Versão mais recente informada pelo pacote npm do OpenCode e pelos lançamentos do GitHub.",
  "settings.fork.runtime.opencode.latestInstalled": "O processo conectado do OpenCode está na versão mais recente disponível.",
  "settings.fork.runtime.opencode.manager": "Gerenciador do ciclo de vida",
  "settings.fork.runtime.opencode.managerSupported": "Este ambiente oferece suporte a uma atualização supervisionada. Uma reinicialização independente está disponível para o OpenCode gerenciado pelo systemd.",
  "settings.fork.runtime.opencode.managerUnsupported": "Este processo do OpenCode não é gerenciado pelo ambiente do OpenChamber conectado.",
  "settings.fork.runtime.opencode.activeAgentSingle": "{count} agente ativo precisa terminar antes que a operação continue.",
  "settings.fork.runtime.opencode.activeAgentPlural": "{count} agentes ativos precisam terminar antes que a operação continue.",
  "settings.fork.runtime.opencode.operation.updateQueued": "Atualização na fila; aguardando os agentes ativos",
  "settings.fork.runtime.opencode.operation.restartQueued": "Reinicialização na fila; aguardando os agentes ativos",
  "settings.fork.runtime.opencode.operation.updating": "Instalando a versão mais recente do OpenCode",
  "settings.fork.runtime.opencode.operation.restarting": "Reiniciando o OpenCode e reconectando os transportes",
  "settings.fork.runtime.opencode.operation.updated": "Atualização do OpenCode concluída",
  "settings.fork.runtime.opencode.operation.restarted": "Reinicialização do OpenCode concluída",
  "settings.fork.runtime.opencode.updateAction": "Atualizar o OpenCode para a versão mais recente",
  "settings.fork.runtime.opencode.updateAvailable": "A versão {version} está disponível. Os agentes ativos podem terminar antes da reinicialização gerenciada.",
  "settings.fork.runtime.opencode.noUpdate": "Nenhuma versão mais recente do OpenCode está disponível no momento.",
  "settings.fork.runtime.opencode.updateUnsupported": "Este ambiente não pode atualizar o processo conectado do OpenCode.",
  "settings.fork.runtime.opencode.restartAction": "Reiniciar o OpenCode",
  "settings.fork.runtime.opencode.restartDescription": "Bloqueia novos turnos, aguarda os agentes ativos terminarem, reinicia o serviço externo do OpenCode e reconecta o OpenChamber.",
  "settings.fork.runtime.opencode.restartUnsupported": "A reinicialização independente requer o ambiente externo supervisionado pelo systemd.",
  "settings.fork.runtime.openchamber.title": "OpenChamber",
  "settings.fork.runtime.openchamber.description": "Revisões carregadas do servidor e da interface, checkout atual, versões upstream e estado da implantação gerenciada a partir do código-fonte.",
  "settings.fork.runtime.openchamber.running": "Revisão do servidor em execução",
  "settings.fork.runtime.openchamber.loadedUi": "Revisão carregada da interface do navegador",
  "settings.fork.runtime.openchamber.loadedUiMismatch": "Os recursos carregados do navegador diferem da revisão do servidor em execução.",
  "settings.fork.runtime.openchamber.loadedUiMatches": "Os recursos carregados do navegador correspondem à revisão do servidor em execução.",
  "settings.fork.runtime.openchamber.loadedUiDirty": "A interface do navegador foi compilada a partir de um checkout com alterações locais.",
  "settings.fork.runtime.openchamber.loadedUiClean": "A interface do navegador foi compilada a partir de um checkout limpo.",
  "settings.fork.runtime.openchamber.checkout": "Revisão do código-fonte em checkout",
  "settings.fork.runtime.openchamber.restartRequired": "Reinicie o OpenChamber para executar esta revisão em checkout.",
  "settings.fork.runtime.openchamber.customUpstream": "Upstream personalizado mais recente",
  "settings.fork.runtime.openchamber.officialRelease": "Versão oficial mais recente",
  "settings.fork.runtime.openchamber.updateAction": "Baixar e compilar a versão personalizada mais recente",
  "settings.fork.runtime.openchamber.deployment": "Implantação gerenciada do código-fonte",
  "settings.fork.runtime.openchamber.rebuildAction": "Compilar o checkout atual",
  "settings.fork.runtime.openchamber.rebuildDescription": "Compila e valida o checkout limpo atual em uma área de preparação e registra suas dependências e recursos web para a próxima reinicialização do OpenChamber.",
  "settings.fork.runtime.openchamber.sourceCurrent": "O checkout de origem está atualizado.",
  "settings.fork.runtime.openchamber.updateDescription": "Obtém a branch personalizada canônica, valida um fast-forward limpo, instala as dependências e compila em uma área de staging; depois registra a atualização preparada. O código-fonte e os recursos em uso só mudam quando o OpenChamber é reiniciado.",
  "settings.fork.runtime.openchamber.noUpdate": "O checkout está atualizado ou não há uma atualização gerenciada segura disponível. O motivo exato é mostrado acima.",
  "settings.fork.runtime.openchamber.restartApplyDescription": "Reinicia apenas o OpenChamber para carregar o código-fonte e os recursos web preparados. O OpenCode e os agentes ativos continuam em execução.",
  "settings.fork.runtime.openchamber.operation.checking": "Verificando o checkout e a referência upstream canônica",
  "settings.fork.runtime.openchamber.operation.preparing": "Preparando um checkout separado em uma área de staging",
  "settings.fork.runtime.openchamber.operation.installing": "Instalando as dependências preparadas",
  "settings.fork.runtime.openchamber.operation.building": "Compilando e validando os recursos web preparados",
  "settings.fork.runtime.openchamber.operation.applying": "Registrando a atualização preparada para a reinicialização gerenciada",
  "settings.fork.runtime.openchamber.operation.ready": "Atualização personalizada preparada; reinicie o OpenChamber para executá-la",
  "settings.fork.runtime.openchamber.operation.failed": "A atualização personalizada falhou; a revisão em execução não foi reiniciada",
