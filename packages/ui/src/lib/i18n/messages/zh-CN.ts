...
export const dict: Record<I18nKey, string> = {
  ...
  'prime.transcript.readOnly': '只读',
  'harness.selector.label': '编程运行环境',
  'prime.composer.placeholder': '询问 Prime Agent...',
  'prime.status.working': '工作中',
  'prime.unavailable.description': 'Prime Agent 不可用。请在常规设置中配置其可执行文件，或重试连接。',
  'prime.composer.textOnly': 'Prime Agent 目前仅接受文本提示。',
  'prime.composer.ambiguous': 'Prime Agent 可能已收到此请求。重试前请确认其当前状态。',
  'prime.composer.createFailed': '无法创建 Prime Agent 会话。',
  'prime.composer.sendFailed': '无法向 Prime Agent 发送提示。',
  'prime.composer.abortFailed': '无法停止 Prime Agent。',
