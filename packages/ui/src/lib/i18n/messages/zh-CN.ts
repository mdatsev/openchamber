...
export const dict: Record<I18nKey, string> = {
  ...
  'walkthrough.search.placeholder': '搜索差异...',
  'walkthrough.search.resultCount': '第 {current} 项，共 {total} 项',
  'walkthrough.search.previous': '上一个匹配项',
  'walkthrough.search.next': '下一个匹配项',
  'walkthrough.search.close': '关闭搜索',
  ...
  'chat.statusRow.interruptedUnexpectedly': '意外中断',
  ...
  'chat.chatInput.placeholder.prime': '向 Prime Agent 发送消息…',
  'chat.primeComposer.pending': '正在更新 Prime Agent…',
  'chat.primeComposer.outcomeUncertain': 'Prime Agent 可能已收到此操作。再次选择该操作即可安全重试。',
  'chat.primeComposer.failed': 'Prime Agent 无法完成此操作。',
  'chat.primeComposer.draftLimitReached': '消息大小上限为 256 KiB。',
  "chat.draftHarness.pickerAria": "选择智能体框架",
  "chat.primeDraft.creating": "正在创建 Prime Agent 会话…",
  "chat.primeDraft.creationUncertain": "创建可能已成功。重试前请先检查会话列表。",
  "chat.primeDraft.unsupported": "此运行时不支持创建 Prime Agent 会话。",
  "chat.primeDraft.creationFailed": "无法创建 Prime Agent 会话。",
  "chat.primeDraft.configurationUnavailable": "所选模型或思考设置已无法从最新的 Prime 会话中获取。草稿已保留。",
  "chat.primeDraft.sourceRefreshFailed": "无法刷新 Prime 选项。请稍等片刻后重试；草稿已保留。",
  "chat.primeDraft.modelControls.defaults": "Prime 默认设置",
  "chat.primeDraft.modelControls.loadOptions": "加载 Prime 选项",
  "chat.primeDraft.modelControls.loadingOptions": "正在加载 Prime 选项…",
  "chat.primeDraft.modelControls.optionsRequireExistingSession": "Prime 选项需要已有的 Prime 会话",
  "chat.primeDraft.modelControls.primeDefaultThinking": "Prime 默认思考设置",
  "chat.primeSession.liveControls.readOnly": "实时控件已断开连接。保留的会话记录为只读。",
  "chat.primeSession.liveControls.reconnect": "重新连接",
  "chat.primeSession.liveControls.enable": "启用实时控件",
  "chat.primeSession.liveControls.reconnecting": "正在重新连接…",
  "chat.primeComposer.liveReconnecting": "正在重新连接实时控件…",
  'chat.primeSession.readOnlyUnavailable': '此 Prime Agent 对话为只读。无法重新打开其运行时，因此实时上下文和消息控件不可用。',
  ...
  'chat.toolPart.ipythonDiffsOmitted': "已省略的编辑差异：{count}",
  ...
  'updateDialog.sourceRun.description': '此安装正在从源代码运行。请将上游版本合并到自定义分支中，然后重启 OpenChamber。',
  ...
  'updateDialog.actions.mergeUpstreamRelease': '合并上游版本以更新',
  ...
  'chat.container.partialTranscript.description': '正在显示当前可用的对话记录。部分较旧、过大或不可用的数据可能不会显示。',
};
