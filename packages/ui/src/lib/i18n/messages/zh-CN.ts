...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.group.empty.noSessions': '无会话',
  ...
  'sessions.sidebar.session.moveToWorktree.confirm.title': '要移动未提交的更改吗？',
  'sessions.sidebar.session.moveToWorktree.confirm.description': '此检出中有未提交的更改。请选择将其移动到新工作树，或留在当前检出中。',
  'sessions.sidebar.session.moveToWorktree.confirm.leaveChanges': '保留更改',
  'sessions.sidebar.session.moveToWorktree.confirm.moveChanges': '移动更改',
  ...
  'sessions.sidebar.session.status.linkedWorktree': '链接工作树',
  'sessions.sidebar.session.status.worktreeClean': '与 {branch} 无差异',
  ...
  "diffView.scope.branchAgainst": "与 {branch} 的差异",
  "diffView.scope.workingTree": "工作区",
  "diffView.comparison.mode.uncommitted": "未提交",
  "diffView.comparison.mode.committed": "已提交",
  "diffView.comparison.mode.combined": "合并显示",
  "diffView.comparison.mode.selectorAria": "选择比较模式",
  "diffView.comparison.layer.committed": "已提交的更改",
  "diffView.comparison.layer.staged": "已暂存的更改",
  "diffView.comparison.layer.unstaged": "未暂存的更改",
  "diffView.comparison.layer.untracked": "未跟踪的文件",
  "diffView.comparison.layer.combined": "合并的更改",
  "diffView.state.loadingBranchChanges": "正在加载分支更改...",
  "diffView.state.branchLoadFailed": "无法加载分支更改",
  "diffView.state.noBranchChanges": "与 {branch} 无差异",
  "diffView.state.noUncommittedChanges": "没有未提交的更改",
  "diffView.state.noCommittedChanges": "与 {branch} 相比没有已提交的更改",
  "diffView.state.noCombinedChanges": "与 {branch} 相比没有已提交或未提交的更改",
  "sessions.sidebar.worktreeChanges": "与 {branch} 不同的文件：{count}",
  ...
  'chat.toolPart.lineDiffUnavailable': '此行超过 {limit} 个字符，因此不会突出显示词级更改。',
  ...
  'updateDialog.sourceRun.description': '此安装正在从源代码运行。请让智能体将上游版本合并到自定义分支，完成验证，然后重启 OpenChamber。',
  ...
  'updateDialog.actions.mergeUpstreamRelease': '需要智能体合并',
