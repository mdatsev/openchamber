...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  'settings.openchamber.primeAgent.field.binaryPath': 'Ruta del ejecutable de Prime Agent',
  'settings.openchamber.primeAgent.field.binaryPathInfo': 'Elige el ejecutable o iniciador de Prime Agent. Si se deja vacío, OpenChamber comprueba PRIME_AGENT_BINARY y luego PATH.',
  'settings.openchamber.primeAgent.actions.browseAria': 'Buscar el ejecutable de Prime Agent',
  'settings.openchamber.primeAgent.actions.save': 'Guardar',
