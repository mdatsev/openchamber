...
export const settingsDict = {
  ...
  "settings.page.fork.title": "Configuración del fork",
  "settings.page.fork.description": "Ajustes y acciones del entorno disponibles solo en este fork personalizado de OpenChamber.",
  "settings.fork.section.worktrees": "Worktrees",
  "settings.fork.startNewChatInWorktree.label": "Iniciar chats nuevos en el worktree actual",
  "settings.fork.startNewChatInWorktree.info": "Al iniciar un chat nuevo desde un worktree, usa ese worktree en lugar del checkout principal del proyecto. Los proyectos y worktrees seleccionados explícitamente no cambian.",
  "settings.fork.section.runtime": "Entorno de ejecución",
  "settings.fork.restart.label": "Reiniciar OpenChamber",
  "settings.fork.restart.info": "Reinicia solo esta interfaz de OpenChamber. OpenCode y los agentes activos siguen ejecutándose, y esta página se recarga cuando la interfaz vuelve a estar disponible.",
  "settings.fork.restart.action": "Reiniciar",
  "settings.fork.restart.checking": "Comprobando...",
  "settings.fork.restart.restarting": "Reiniciando...",
  "settings.fork.restart.checkAgain": "Comprobar de nuevo",
  "settings.fork.restart.unavailable": "No disponible",
  "settings.fork.restart.loadError": "No se pudo comprobar si este entorno admite el reinicio administrado.",
  "settings.fork.restart.failed": "No se pudo reiniciar OpenChamber.",
  "settings.fork.restart.timeout": "OpenChamber está tardando más de lo esperado en reiniciarse. Prueba a recargar esta página.",
  "settings.fork.opencodeUpdate.label": "Actualizar OpenCode",
  "settings.fork.opencodeUpdate.info": "Actualiza solo OpenCode. En el entorno supervisado por systemd, espera a que terminen los agentes activos y luego reinicia OpenCode. OpenChamber y las ramas de Git no cambian.",
  "settings.fork.opencodeUpdate.state.updateUnavailable": "Este entorno de OpenCode no está administrado por este fork.",
  "settings.fork.opencodeUpdate.state.checkFailed": "No se pudo comprobar si hay actualizaciones de OpenCode.",
  "settings.fork.opencodeUpdate.state.queued": "Esperando a que terminen los agentes activos antes de actualizar OpenCode.",
  "settings.fork.opencodeUpdate.state.restarting": "Reiniciando OpenCode...",
  "settings.fork.opencodeUpdate.actions.queued": "En cola",
  "settings.fork.runtime.checking": "Comprobando...",
  "settings.fork.runtime.refresh": "Actualizar estado",
  "settings.fork.runtime.loadFailed": "No se pudo cargar el estado del entorno de ejecución.",
  "settings.fork.runtime.actionFailed": "La acción del entorno de ejecución falló.",
  "settings.fork.runtime.cancelFailed": "No se pudo cancelar la operación en cola.",
  "settings.fork.runtime.unknown": "Desconocido",
  "settings.fork.runtime.unavailable": "No disponible",
  "settings.fork.runtime.none": "Ninguno",
  "settings.fork.runtime.current": "Al día con el upstream personalizado",
  "settings.fork.runtime.ahead": "Commits por delante del upstream personalizado: {count}",
  "settings.fork.runtime.behind": "Commits por detrás del upstream personalizado: {count}",
  "settings.fork.runtime.diverged": "Los historiales han divergido; la actualización gestionada está bloqueada.",
  "settings.fork.runtime.comparisonUnknown": "La comparación con el upstream personalizado no está disponible.",
  "settings.fork.runtime.release": "Versión publicada: {version}",
  "settings.fork.runtime.tag": "Etiqueta exacta: {tag}",
  "settings.fork.runtime.branch": "Rama: {branch}",
  "settings.fork.runtime.clean": "El checkout está limpio",
  "settings.fork.runtime.dirty": "El checkout tiene cambios locales",
  "settings.fork.runtime.stale": "Este es el último resultado correcto; la actualización más reciente falló.",
  "settings.fork.runtime.startedAt": "Proceso iniciado: {time}",
  "settings.fork.runtime.status.label": "Origen del estado",
  "settings.fork.runtime.status.checkedAt": "Comprobado: {time}",
  "settings.fork.runtime.status.notChecked": "El estado aún no se ha comprobado.",
  "settings.fork.runtime.operation.label": "Operación actual",
  "settings.fork.runtime.operation.idle": "No hay ninguna operación en curso",
  "settings.fork.runtime.operation.failed": "La operación falló",
  "settings.fork.runtime.operation.from": "Commit de origen: {commit}",
  "settings.fork.runtime.operation.target": "Commit de destino: {commit}",
  "settings.fork.runtime.operation.updatedAt": "Última actualización del progreso: {time}",
  "settings.fork.runtime.opencode.title": "OpenCode",
  "settings.fork.runtime.opencode.description": "Proceso activo, ejecutable instalado, versión pública y estado del ciclo de vida supervisado.",
  "settings.fork.runtime.opencode.runningVersion": "Versión en ejecución / conectada",
  "settings.fork.runtime.opencode.runningVersionDescription": "Indicada por el proceso de OpenCode conectado actualmente a este servidor de OpenChamber.",
  "settings.fork.runtime.opencode.installedVersion": "Versión del ejecutable instalado",
  "settings.fork.runtime.opencode.installedVersionDescription": "Leída directamente del ejecutable configurado para el servicio gestionado de OpenCode.",
  "settings.fork.runtime.opencode.latestVersion": "Última versión pública",
  "settings.fork.runtime.opencode.latestVersionDescription": "Versión más reciente indicada por el paquete npm de OpenCode y las versiones de GitHub.",
  "settings.fork.runtime.opencode.latestInstalled": "El proceso de OpenCode conectado usa la última versión disponible.",
  "settings.fork.runtime.opencode.manager": "Gestor del ciclo de vida",
  "settings.fork.runtime.opencode.managerSupported": "Este entorno de ejecución admite una actualización supervisada. OpenCode gestionado por systemd permite un reinicio independiente.",
  "settings.fork.runtime.opencode.managerUnsupported": "Este proceso de OpenCode no está gestionado por el entorno de OpenChamber conectado.",
  "settings.fork.runtime.opencode.activeAgentSingle": "{count} agente activo debe terminar antes de que continúe la operación.",
  "settings.fork.runtime.opencode.activeAgentPlural": "Deben terminar {count} agentes activos antes de que continúe la operación.",
  "settings.fork.runtime.opencode.operation.updateQueued": "Actualización en cola; esperando a los agentes activos",
  "settings.fork.runtime.opencode.operation.restartQueued": "Reinicio en cola; esperando a los agentes activos",
  "settings.fork.runtime.opencode.operation.updating": "Instalando la última versión de OpenCode",
  "settings.fork.runtime.opencode.operation.restarting": "Reiniciando OpenCode y volviendo a conectar los transportes",
  "settings.fork.runtime.opencode.operation.updated": "Actualización de OpenCode completada",
  "settings.fork.runtime.opencode.operation.restarted": "Reinicio de OpenCode completado",
  "settings.fork.runtime.opencode.updateAction": "Actualizar OpenCode a la última versión",
  "settings.fork.runtime.opencode.updateAvailable": "La versión {version} está disponible. Los agentes activos pueden terminar antes del reinicio gestionado.",
  "settings.fork.runtime.opencode.noUpdate": "Actualmente no hay ninguna versión más reciente de OpenCode disponible.",
  "settings.fork.runtime.opencode.updateUnsupported": "Este entorno de ejecución no puede actualizar el proceso de OpenCode conectado.",
  "settings.fork.runtime.opencode.restartAction": "Reiniciar OpenCode",
  "settings.fork.runtime.opencode.restartDescription": "Impide nuevos turnos, espera a que terminen los agentes activos, reinicia el servicio externo de OpenCode y vuelve a conectar OpenChamber.",
  "settings.fork.runtime.opencode.restartUnsupported": "El reinicio independiente requiere el entorno externo supervisado por systemd.",
  "settings.fork.runtime.openchamber.title": "OpenChamber",
  "settings.fork.runtime.openchamber.description": "Revisiones cargadas del servidor y de la interfaz, checkout actual, versiones upstream y estado del despliegue gestionado del código fuente.",
  "settings.fork.runtime.openchamber.running": "Revisión del servidor en ejecución",
  "settings.fork.runtime.openchamber.loadedUi": "Revisión cargada de la interfaz del navegador",
  "settings.fork.runtime.openchamber.loadedUiMismatch": "Los recursos cargados del navegador difieren de la revisión del servidor en ejecución.",
  "settings.fork.runtime.openchamber.loadedUiMatches": "Los recursos cargados del navegador coinciden con la revisión del servidor en ejecución.",
  "settings.fork.runtime.openchamber.loadedUiDirty": "La interfaz del navegador se compiló a partir de un checkout con cambios locales.",
  "settings.fork.runtime.openchamber.loadedUiClean": "La interfaz del navegador se compiló a partir de un checkout limpio.",
  "settings.fork.runtime.openchamber.checkout": "Revisión del código fuente extraída",
  "settings.fork.runtime.openchamber.restartRequired": "Reinicia OpenChamber para ejecutar esta revisión extraída.",
  "settings.fork.runtime.openchamber.customUpstream": "Último upstream personalizado",
  "settings.fork.runtime.openchamber.officialRelease": "Última versión oficial",
  "settings.fork.runtime.openchamber.updateAction": "Obtener y compilar la última versión personalizada",
  "settings.fork.runtime.openchamber.deployment": "Implementación administrada del código fuente",
  "settings.fork.runtime.openchamber.rebuildAction": "Compilar el checkout actual",
  "settings.fork.runtime.openchamber.rebuildDescription": "Compila y valida el checkout limpio actual en un entorno de preparación y registra sus dependencias y recursos web para el próximo reinicio de OpenChamber.",
  "settings.fork.runtime.openchamber.sourceCurrent": "El checkout de origen está actualizado.",
  "settings.fork.runtime.openchamber.updateDescription": "Obtiene la rama personalizada canónica, valida un avance rápido limpio, instala las dependencias y compila en un entorno de preparación; después registra la actualización preparada. El código fuente y los recursos activos solo cambian cuando se reinicia OpenChamber.",
  "settings.fork.runtime.openchamber.noUpdate": "El checkout está al día o no hay disponible una actualización gestionada segura. El motivo exacto se muestra arriba.",
  "settings.fork.runtime.openchamber.restartApplyDescription": "Reinicia solo OpenChamber para cargar el código fuente y los recursos web preparados. OpenCode y los agentes activos siguen ejecutándose.",
  "settings.fork.runtime.openchamber.operation.checking": "Comprobando el checkout y el upstream autorizado",
  "settings.fork.runtime.openchamber.operation.preparing": "Preparando un checkout independiente en el entorno de preparación",
  "settings.fork.runtime.openchamber.operation.installing": "Instalando las dependencias en el entorno de preparación",
  "settings.fork.runtime.openchamber.operation.building": "Compilando y validando los recursos web en el entorno de preparación",
  "settings.fork.runtime.openchamber.operation.applying": "Registrando la actualización preparada para el reinicio gestionado",
  "settings.fork.runtime.openchamber.operation.ready": "Actualización personalizada preparada; reinicia OpenChamber para ejecutarla",
  "settings.fork.runtime.openchamber.operation.failed": "La actualización personalizada falló; la revisión en ejecución no se reinició",
