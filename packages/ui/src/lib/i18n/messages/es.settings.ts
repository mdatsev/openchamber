...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.opencodeCli.field.update": "Actualización de OpenCode",
  "settings.openchamber.opencodeCli.field.updateInfo": "Solo actualiza la CLI de OpenCode. No actualiza OpenChamber ni modifica ramas de Git.",
  "settings.openchamber.opencodeCli.state.updateUnavailable": "Este entorno de ejecución de OpenCode no se puede actualizar aquí.",
  "settings.openchamber.opencodeCli.state.checkFailed": "No se pudo comprobar si hay actualizaciones de OpenCode.",
