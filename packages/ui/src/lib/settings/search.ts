...
const SETTINGS_SEARCH_ITEMS: readonly SettingsSearchItem[] = [
  ...
  },
  {
    ...
    page: 'fork',
    titleKey: 'settings.fork.runtime.opencode.updateAction',
  ...
  {
    id: 'fork.runtime-opencode',
    page: 'fork',
    titleKey: 'settings.fork.runtime.opencode.title',
    descriptionKey: 'settings.fork.runtime.opencode.description',
    keywords: ['opencode', 'runtime', 'versions', 'systemd'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'fork.opencode-running',
    page: 'fork',
    titleKey: 'settings.fork.runtime.opencode.runningVersion',
    descriptionKey: 'settings.fork.runtime.opencode.runningVersionDescription',
    keywords: ['opencode', 'connected', 'running', 'version'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'fork.opencode-installed',
    page: 'fork',
    titleKey: 'settings.fork.runtime.opencode.installedVersion',
    descriptionKey: 'settings.fork.runtime.opencode.installedVersionDescription',
    keywords: ['opencode', 'installed', 'binary', 'executable', 'version'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'fork.opencode-latest',
    page: 'fork',
    titleKey: 'settings.fork.runtime.opencode.latestVersion',
    descriptionKey: 'settings.fork.runtime.opencode.latestVersionDescription',
    keywords: ['opencode', 'latest', 'release', 'version'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'fork.opencode-manager',
    page: 'fork',
    titleKey: 'settings.fork.runtime.opencode.manager',
    keywords: ['opencode', 'manager', 'systemd', 'lifecycle'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'fork.opencode-operation',
    page: 'fork',
    titleKey: 'settings.fork.runtime.operation.label',
    keywords: ['opencode', 'operation', 'progress', 'agents', 'queued'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'fork.restart-opencode',
    page: 'fork',
    titleKey: 'settings.fork.runtime.opencode.restartAction',
    descriptionKey: 'settings.fork.runtime.opencode.restartDescription',
    keywords: ['opencode', 'restart', 'systemd', 'agents'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'fork.runtime-openchamber',
    page: 'fork',
    titleKey: 'settings.fork.runtime.openchamber.title',
    descriptionKey: 'settings.fork.runtime.openchamber.description',
    keywords: ['openchamber', 'runtime', 'commit', 'release', 'fork'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'fork.openchamber-refresh',
    page: 'fork',
    titleKey: 'settings.fork.runtime.status.label',
    keywords: ['refresh', 'fetch', 'status', 'upstream'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'fork.openchamber-running',
    page: 'fork',
    titleKey: 'settings.fork.runtime.openchamber.running',
    keywords: ['openchamber', 'running', 'server', 'commit', 'release'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'fork.openchamber-loaded-ui',
    page: 'fork',
    titleKey: 'settings.fork.runtime.openchamber.loadedUi',
    keywords: ['openchamber', 'ui', 'assets', 'build', 'commit'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'fork.openchamber-checkout',
    page: 'fork',
    titleKey: 'settings.fork.runtime.openchamber.checkout',
    keywords: ['openchamber', 'checkout', 'source', 'branch', 'dirty', 'commit'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'fork.openchamber-custom-upstream',
    page: 'fork',
    titleKey: 'settings.fork.runtime.openchamber.customUpstream',
    keywords: ['openchamber', 'custom', 'upstream', 'mdatsev', 'commit', 'release'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'fork.openchamber-official-release',
    page: 'fork',
    titleKey: 'settings.fork.runtime.openchamber.officialRelease',
    keywords: ['openchamber', 'official', 'upstream', 'latest', 'release'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'fork.openchamber-operation',
    page: 'fork',
    titleKey: 'settings.fork.runtime.operation.label',
    keywords: ['openchamber', 'operation', 'build', 'install', 'progress', 'log'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'fork.update-openchamber',
    page: 'fork',
    titleKey: 'settings.fork.runtime.openchamber.updateAction',
    descriptionKey: 'settings.fork.runtime.openchamber.updateDescription',
    keywords: ['openchamber', 'pull', 'fetch', 'build', 'update', 'custom'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
