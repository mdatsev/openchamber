...
- Authenticated `stat`, text-read, and raw-read routes allow direct outside-workspace paths without a grant. Write routes keep canonical-target boundary checks.
